...
\section{Currently Reading}
  \subsection{Wagner 2002: }
  \citet{Wagner2002}
    {\small 
    Methane is the major precursor to HCHO in the marine boundary layer, and the remote atmosphere.
...
\section{VOCs}
  ...
  \subsection{Crutzen 1999}
    \citet{Crutzen1999}
    Photolysis of ozone drive excited O($^1$D) production, which react with water and produce OH radicals.
    In background atmosphere OH mostly reacts with CO and CH$_4$ and some of it's oxidation products, which in turn are oxidised by OH.
    If NO$_X$ is present, ozone may be produced or destroyed in large quantities (greater than the stratospheric source).
    
    OH is mostly present in the tropics, and the difference in OH and O$_3$ production between ocean and continental regions is much greater than the difference between hemispheres.
    Ozone in the lower troposphere is only weakly dependent on stratospheric ozone levels, mostly driven by in-situ production.
    This is shown through simulating a lower stratospheric ozone level (10\%) and seeing 70-90\% ozone in the lower troposphere.
  ...
  } % small means this is in the lit review or thesis somewhere
...
%----------------------------------------------------------------------------------------
\section{Modelling}
  \subsection{Zheng 2016}
    \citet{Zheng2016}
    ``We conclude that proxy-based inventories are of sufficient quality to support regional and global models (larger than 0.25 degrees in this case study);
    however, to support urban-scale models with accurate emission inputs, bottom-up inventories incorporating exact locations of emitting facilities have to be developed instead.''
%----------------------------------------------------------------------------------------
%	Ozone Papers
%----------------------------------------------------------------------------------------
\section{Ozone}
