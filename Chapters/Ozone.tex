...
\section{Background}
  ...
  \subsection{Stratosphere to Troposphere ozone Transport (STT)}
    ...
    A high correlation is found between lower stratospheric and tropospheric ozone \citep{Terao_2008} with the highest STT associated with the jet-streams over the oceans in winter.
...
\section{GEOS-Chem ozonesonde comparison}
  ...
  \subsection{Direct comparison of event profiles}
