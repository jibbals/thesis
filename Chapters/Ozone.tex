...
\section{GEOS-Chem ozonesonde comparison}
  ...
  \subsection{Ozone profiles compared with GEOS-Chem}
    ...
    TODO: deseasonalise correlation?
    Quantitatively, the modelled tropospheric profile correlates well with the ozone sonde profiles.
    
    
    \begin{figure}[!htbp]
      \includegraphics[width=0.8\textwidth]{Figures/Ozone/station_correlations.png}
      ...
      The line of best fit (black) and one to one line (grey) is also shown, note the axes are different for Melbourne.}
