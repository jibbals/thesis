...
\section{GEOS-Chem ozonesonde comparison}
  \subsection{Why compare to a model}
  ...
  \subsection{GEOS-Chem stratospheric unified chemistry extension (UCX)}
    ...
    The stratospheric chemistry, including photolysis, is also modeled and stratosphere-troposphere coupling is calculated with the addition of UCX \citep{Eastham2014}, which also includes a further 28 trace gases.
    Various emissions used by GEOS-Chem as boundary conditions are taken from an extended version of Model of Emissions of Gases and Aerosols from Nature version 2.1 (MEGAN2.1) \citep{Guenther2012}.
    Atmospheric parameters and boundary conditions are sourced from NASA/GMAO's GEOS-5 operational data products.
    
    GEOS-Chem values used within this chapter are based on a simulation using UCX from 2004-2013 exclusive, with 2004 used as a spinup year.
    ...
    Our GEOS-Chem run included a fix for properly reading the TOMS information, GEOS-Chem 10.01 mishandles the missing values otherwise.
