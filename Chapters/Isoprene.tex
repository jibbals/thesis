...
\label{ch_isop:sec:IsopreneEmissions}
  ...
  \subsection{Calculations of uncertainty}
    ...
    This AMF uncertainty is determined through TODO:Paul palmer calculation and combination for overall Satellite VC uncertainty per pixel and gridded.
    
    Model uncertainty is harder to determine, TODO: find out how this is estimated in other papers.
