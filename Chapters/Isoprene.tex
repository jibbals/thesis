...
\label{ch_isop:sec:satelliteHCHO}
  \subsection{Satellite Retrievals}
    ...
    This can be reduced through temporal or spatial averaging, as the uncertainty decreases by a factor of $1/\sqrt{N}$ where N is the number of observations being averaged.
    Taking the eight day gridded average with horizontal resolution of 0.25 by 0.3125 degrees (latitude by longitude) typically reduces the uncertainty from TODO: numbers.
