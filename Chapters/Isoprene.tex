...
\label{ch_isop:sec:creatinginventory}
  ...
  \subsection{Process Outline}
    ...
    TODO: mention rough random error reduction from 8 day averaging process (1/root n)
    ...
    In part this is due to the sensitivity of instruments varying vertically through the atmosphere.
