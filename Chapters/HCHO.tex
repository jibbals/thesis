...
\label{ch_HCHO:sec:modelHCHO}
  \subsection{Run comparisons}
    ...
    \begin{figure}[!htbp]
      \includegraphics[width=\textwidth]{Figures/HCHO/GClink/tropchem_hcho_20050101.png}
      \caption{ %
    ...
    \begin{figure}[!htbp]
      \includegraphics[width=\textwidth]{Figures/HCHO/GClink/UCX_vs_tropchem_hcho_20050101.png}
      \caption{ %
    ...
    \begin{figure}[!htbp]
      \includegraphics[width=\textwidth]{Figures/HCHO/GClink/UCX_vs_tropchem_isop_20050101.png}
      \caption{%
