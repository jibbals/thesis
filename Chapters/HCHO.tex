...
\label{ch_HCHO:sec:satelliteHCHO}
  ...
  \subsection{Air Mass Factors}
    ...
    The original method for HCHO is layed out in \cite{Palmer2001}, with modifications for clouds \citep{Martin2002} and use of the LIDORT RTM \citep{Spurr2002} is described by \cite{Martin2003} (TODO: cite Martin2001: \url{http://acmg.seas.harvard.edu/publications/martin2001a.pdf}, Spurr: \url{http://www.cfa.harvard.edu/atmosphere/publications/jqsrt-lidort-2002a.pdf}, Martin2003: \url{http://acmg.seas.harvard.edu/publications/martin2003a.pdf} ).
