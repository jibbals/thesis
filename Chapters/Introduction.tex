...
\label{LR:O3}
  ...
  Generally there are two main drivers of tropospheric ozone concentrations; transport from the stratosphere and creation due to emissions of precursors. 
  Globally, most ozone is produced by naturally (biogenic) emitted precursors.
  At smaller scales, near cities or downwind of fires, these pyrogenic and anthropogenic emissions become more important.
