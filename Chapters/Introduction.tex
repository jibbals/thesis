...
\label{LR:Atmos}
  ...
  Beyond these major constituents the atmosphere has a vast number of trace gases, including carbon dioxide (CO$_2$: $\sim 0.4\%$), ozone (O$_3$: $.000001$ to $0.001\%$), and methane (CH$_4$: $\sim 0.4\%$) \citep[][Ch. 2]{BrasseurJacob2017}.
  ...
  Around 5 to 20 percent of all air pollution related deaths are due to ozone \citep{Monks2015}, roughly .8 million deaths per year \citep{Lelieveld2013}.
  ...
  Recently \citet{Yue2017} showed that the net effect of near-surface ozone on is a $\sim 14\%$ decrease in net primary productivity in China.
  ...
  \label{LR:Atmos:Chem}
    ...
    %\label{LR:Atmos:Chem:radicals}
      ...
      The OH radical drives many processes in the atmosphere, especially during the day when photolysis of ozone maintains relatively high OH concentrations \citep{Atkinson2000}.
      ...
      Since radicals are involved in all oxidative chemistry in the atmosphere it is important for models to accurately represent them (eg. \citet{Travis2014}).
      ...
      In the late 90's it was thought that OH radicals were formed exclusively from photolysis of O$_3$, HONO, HCHO, and other carbonyls (R$_2$C=O) \citep{Atkinson2000}.
      It has been shown since that TODO. %TODO more on OH sources
      Isoprene (C$_5$H$_8$) was thought to be a sink of OH until it was shown by \citet{Paulot2009b} that the radicals are recycled.
      ...
      %\citet{AtkinsonArey2003} discuss the relative rates of these reactions.
...
\label{LR:O3}
  ...
  \subsection{Stratospheric ozone}
    ...
    The Chapman mechanism requires radiation so only takes place during the daytime, during the night this process slows to a halt, and the ozone concentrations remain stable unless pollution intrudes \citep[Chapter 10]{Jacob_1999_book}.
  ...
  \subsection{Tropospheric ozone}
    Figure \ref{LR:O3:fig_YoungOzoneSummary}, copied from \citet{Young2018}, shows summary of the major processes and emissions affecting tropospheric ozone.
    This thesis involves improving the highly uncertain natural emissions of VOCs from Australia, and estimating impacts from STEs.
    
    \begin{figure}
      \includegraphics[width=\textwidth]{Figures/Young2018_Figure1.png}
      \caption{%
        Tropospheric ozone processes, Figure 1 in \citet{Young2018}.
    ...
    \end{equation}
    This process with and without the influence of VOCs (panel A and B respectively) in figure \ref{LR:O3:fig_Atkinson_photoequilibrium}.
    
    \mypicd{width=0.7\textwidth}
      {Figures\Atkinson2000_photoequilibrium.png}
      {Figure showing NO, NO$_2$, and Ozone photoequilibrium cycle with and without (B, A respectively) influence from VOCs. Figure copied from \citet{Atkinson2000}.}
  ...
  \subsection{Stratosphere to troposphere transport}
    ...
    The proportion of tropospheric ozone due to transport from the stratosphere was revised down to around 10\% over the years as measurement and modelling campaigns improved our understanding of global scale transport, mixing, and chemistry \citep{Guenther2006,Monks2015}.
    Recently \citet{Kuang2017} analysed tropospheric ozone measurements in south-east USA and observed STT influence which can be seen to affect surface ozone levels.
    In their work they use several different instruments and analyse the structure and temporal evolution of ozone, showing how ozone depends on both the local topography, weather systems, and trace gases emitted and transported into the region.
    ...
    STT often occur as tongues of stratospheric air descend and get disconnected from the stratosphere, potentially due to low pressure systems and jet streams \citet{Sprenger2003}.
    ...
    There are a few methods of doing this, such as \citet{Ojha2016}, who use a model that keeps track of ozone formed in (and transported from) the stratosphere.
    ...
    \citet{Liu2017} examine southern hemispheric ozone and the processes which control its inter-annual variability (IAV).
    ...
    In the USA recent work by \citet{Lin2015} suggests that intrusions during spring are increasing surface ozone levels.
  ...
  \subsection{Chemical production}
    ...
    A recent summary by \citet{Young2018} estimates ozone production and loss in the troposphere to be $\sim$4900\tgpyr, and $\sim$4500\tgpyr respectively, while STT sources are $\sim$500\tgpyr. 
    ...
    Figure \ref{LR:VOCs:fig_NOXVOCOzone} shows the non-linear affect of NO$_X$ and VOC concentrations on ozone production over Houston, as modelled in \citet{Mazzuca2016}.
...
\label{LR:VOCs}
  ...
  A regional-model study in Europe \citep{Aksoyoglu2017} has also shown VOCs impact secondary inorganic aerosol concentrations.
  ...
  \subsection{Emissions}
    ...
    Methane and isoprene each comprise around a third of the global total emissions of VOCs \citep{Guenther2006}.
    ...
    Globally around 710 - 1150 Tg C yr$^{-1}$ of BVOCs are emitted \citep{Guenther1995,Lathiere2006,Guenther2012, Lathiere2016}.
    ...
    It used to be thought that emissions of anthropogenic and biogenic VOCs (AVOCs, BVOCs respectively) were roughly similar (\citet{Muller1992}, TODO: more cites).
    In the 1990's it became clear that biogenic emissions are in fact dominant \citep{Guenther1995,} TODO: more cites. 
    ...
    The main non-methane BVOC emissions are isoprene (44\%) and monoterpenes (11\%) \citep{Guenther2000, Kefauver2014}. 
  ...
  \label{LR:VOCs:Isop}
    ...
    \citet{Guenther1995}, and subsequent updates \citep{Guenther2000,Guenther2006,Guenther2012}, have been used ubiquitously by the atmospheric community as a global estimate of isoprene emissions, at roughly 500-600\tgpyr, emitted mostly during the day.
    Recently an estimate of global isoprene emissions has been made using a completely different model, of around 465~Tg C yr$^{-1}$, by \citet{Messina2016} using ORCHIDEE.
    ...
    \citet{Kanakidou2005} summarised how chamber experiments used to measure isoprene reactions may be unsuitable for comparison to the natural atmosphere.
    In \citet{Nguyen2014} many scientists and groups worked together on chamber measurements, to improve understanding of ambient atmospheric oxidation mechanisms of biogenic hydrocarbons (such as isoprene).
  ...
  \subsection{The isoprene cascade}
    ...
    The many children processes and products which begin with isoprene oxidation are often called the isoprene (photochemical) cascade \citet{Crounse2012,Paulot2012,Wolfe2016}.
    ...
    \subsubsection{Oxidation}
      The primary first step for atmospheric isoprene is photooxidation, reacting with OH to form isoprene hydroxyperoxy radicals (\roo) \citep{Wolfe2016,Marvin2017,Patchen2017}.
      There is still uncertainty about which pathways are most important following \roo production: HO$_2$ reactions predominantly produce hydroxyhydroperoxides (ISOPOOH), NO reactions largely produce methyl vinyl ketone (MVK) and methacrolein (MCR), and RO$_2$ reactions are also possible \citet{Liu2016a}.
      
      First isoprene has its double bond replaced by OH, as summarised by the equation from \citet{Patchen2007}:
      % Uses package{mchem}
      ...
      Reactions with NO can lead to ozone production in environments rich in isoprene or other non-methane organic compounds (NMOCs) and NMVOCs \citep{Patchen2007,AtkinsonArey2003}.
      ...
      Any organic nitrates which are formed affect levels of both HO$_X$ (H, OH, peroxy radicals) and NO$_X$, acting as a sink (\citet{Mao2013} and references therein).
      ...
      A portion of isoprene nitrates are recycled back to NO$_X$, so may serve as a reservoir of nitrogen and allow its transport to the boundary layer of remote regions \citep{Patchen2007,Paulot2009a}.
      ...
      Some portion of emitted isoprene leads to SOA, potentially through the formation of methacrylic acid epoxide (MAE) formed by decomposition of methacryloylperoxynitrate (MPAN, a second generation product of isoprene oxidation) as shown in smog chambers and field studies in \citet{Lin2013}.
    ...
    \subsubsection{Low NOx scenario}
      ...
      \citet{Peeters2010} suggested that the work of \citet{Paulot2009b} only partially bridges the gap between clean air OH concentration measurements and models.
      ...
      In \citet{Crounse2012}, MACR products are examined and hydroxy recycling is observed in low NO conditions, backing up results from \citet{Peeters2010}.
      \citet{Peeters2010} showed that HO$_2$ is produced at near unity yields following isoprene oxidation initiated by OH.
      TODO: read more Peeters2010
      
      \citet{Nguyen2014} examine various measurement techniques to determine isoprene reactions in non-laboratory conditions.
    ...
    \subsubsection{Ozononlysis}
      ...
      \citet{Nguyen2016} examine in detail a few of these, with proposed mechanisms for C$_1$ and C$_4$ Criegee intermediate reactions.
  ...
  \subsection{Radiative Forcing}
    ...
    \begin{figure}
      ...
      \caption{%
        ...
        This is an image taken from \citet{IPCC_Chapter2}, found at \url{https://www.ipcc.ch/publications_and_data/ar4/wg1/en/faq-2-1.html}.}
    ...
    \begin{figure}
      ...
      \caption{%
        The overall radiative forcings and uncertainties of several atmospheric constituents
        This is an image taken from \citet{IPCC_AR5_WG1}, chapter 8.}
      \label{LR:VOCs:IsopCascade:RF:fig_IPCC_RF_AR5}
    \end{figure}    
    
    In order to improve understanding of processes involved in radiative forcing, \citet{Kanakidou2005} highlight the need for improving VOC emissions and flux measurements.
    ...
    \citet{Kanakidou2005} concluded that it is very likely that organics contribute to particle growth and formation rates.
...
\label{LR:HCHO}
  ...
  \subsection{Sources and sinks}
    ...
    CH$_4$ concentrations are relatively well constrained in models, with the ACCMIP comparison showing only $\sim3$\% inter-quartile range \citep{Young2013}.
    There is a complex relationship between VOCs, HO$_X$, and NO$_X$: with higher levels of NO$_X$ increase the speed that VOCs are converted into HCHO\citep{Wolfe2016}.
    
    %cbl hcho
    Within the continental boundary layer (CBL), the major source of HCHO enhancement is VOC emissions (which reacting with OH radicals in the presence of NO$_X$) \citep{Wagner2002, Millet2006, Kefauver2014}.
    Enhancements to regional and continental HCHO are largely driven by isoprene emissions \citep{Guenther1995, Palmer2003, Shim2005, Kefauver2014}.
    This is true except near fires or anthropogenic sources of HCHO and precursors \citep{Guenther1995, Kefauver2014, Wolfe2016}.
    ...
    Many of the HCHO yields from terpenoids are estimated through chamber studies which examine the products molecular mass and charge after mixing the compound of choice into a known volume of air (\citet[eg.]{Nguyen2014}).
    ...
    \citet{Nguyen2014} state that one of their goals is to recreate ambient atmosphere in their chamber studies with more accuracy, in order to improve interpretations and allow more accurate model parameters.
    
    %Anthro Sources
    \citet{Millet2008} show that anthropogenic emissions of HCHO in America are mostly negligible, although improved sensitivity from oversampling allowed satellite detection of enhanced HCHO concentrations over Houston and Texas \citep{Zhu2014}.
    ...
    \citet{Fu2007} use GOME measurements over Asia and derive biogenic, anthropogenic, and pyrogenic VOC emissions, and \citet{Zhu2014} use oversampling of the OMI HCHO measurements to determine anthropogenic highly-reactive VOC emissions.
    ...
    Nowadays HCHO concentrations are better understood, however precursor emissions are one of the main unknowns \citep[eg.]{Emmerson2016,Marvin2017}.
    \citet{Marvin2017} found that discrepancies in modelled HCHO concentrations are primarily due to second and later generation isoprene oxidation chemistry.
    
    %% HCHO SINKS
    HCHO has two major sinks, one being reactions with OH (oxidation), the other being photolysis: the process of being broken apart by photons \citep{Crutzen1999, Wagner2002, Levy1972, Kefauver2014}.
  ...
  \subsection{Measurement techniques}
    ...
    This method is used both in the home, and from space, globally for HCHO detection \citep{Guenther1995, Abad2015, Davenport2015}.
    ...
    FTIR and DOAS measurements have a range of uncertainties, including systematic and random measurement errors and uncertain apriori shape factors and water profiles (eg: \citet{Franco2015}).
    ...
    A proton transfer reaction mass spectrometer (PTR-MS) can be used to determine gas phase evolution of terpene oxidation products (\citet[eg.]{Lee2006a,Nguyen2014,Wolfe2016}).
    ...
    \citet{Nguyen2014} use and compare several instruments (including one which is PTR-MS based) in the analysis of isoprene and monoterpene products.
    A Gas Chromatography mass spectrometer (GC-MS) is also able to identify isoprene, monoterpenes, and their products \citet[eg.]{Nguyen2014,Lerner2017}.
    ...
    \citet{Hak2005} examine a single air mass with 8 instruments using the four techniques (MAX-DOAS, FTIR, chromatographic, and flourimetric), and show that reasonable agreements can be achieved.
    ...
    \subsubsection{Satellite measurements}
      ...
      \begin{figure}
        ...
        \caption{%
          An example spectrum showing interferences used for species concentration measurements by GOME-2. Image by EUMETSAT and ESA \citep{GOME2Image}.
          }
      ...
      Isoprene is hard to measure directly due to its short lifetime and weak spectral absorption, instead HCHO is often used as a proxy \citep{Millet2006, Fu2007, Dufour2009, Marais2012, bauwens2013satellite, Kefauver2014, Bauwens2016, Surl2018}.
...
\label{LR:Models}
  ...
  \citet{Zhang2012} examine the outputs from a regional model (WRF/Chem) using three different chemical mechanisms, and they show some model output sensitivity to the choice of mechanism.
  ...
  \subsection{Box models}
    ...
    \citet{Marvin2017} use a box model matching conditions in southeast USA to evaluate isoprene mechanisms from several models.  
  ...
  \subsection{Emissions}
    ...
    Some of these properties include leaf areas, speciated responses to sunlight and temperature, moisture stress, etc \citep{Guenther1995,Guenther2006}.
    Understanding how much isoprene is emitted, when and by what, is complicated.
    One frequently used bottom up emissions model is the Model of Emissions of Gases and Aerosols from Nature (MEGAN, \citet{Guenther1995}).
    ...
    In many CTMs the isoprene emissions are calculated seperately (for example by running MEGAN), and then used as boundary conditions (EG: \citet{Guenther2006}). 
    ...
    For example \citet{Stavrakou2014} examined modelled Asian emissions and altered model parameters for temperature, plant type emission factors, incoming solar radiation (insolation) intensity, land use changes, and palm tree forest expansion.
    ...
    \citet{Marais2014} examine factors affecting isoprene emissions, showing their sensitivity to environmental factors.
    ...
    Current emissions estimates require more validation against observations, and recently a comparison of two major VOC models (MEGAN and ORCHIDEE) was undertaken by \citet{Messina2016} reiterating this requirement.
  ...
  \label{LR:Models:Uncert}
    ...
    \subsubsection{Emissions Inventories}
      ...
      \citet{Zeng2015} examine the affects on CO and HCHO when running simulations with two different inventories.
      TODO: find where I took notes about Zeng2015 and put them here.
      
      It is important to note that many estimates of isoprene emission are based on a few algorithms which can depend greatly on input parameters \citep{Arneth2008,Niinemets2010}.
      \citet{Arneth2008} argue that this monopoly of emissions estimates may be leading us to an incorrect understanding of isoprene chemistry.
    ...
    \subsubsection{Resolution}
      ...
      For example: \citet{Wild2006} show that reduced resolution increases OH concentrations and ozone production rates.
      \citet{Christian2017} find small changes in OH ($<10$\%) in OH, HO$_2$ and ozone concentrations local to the north american arctic, when changing from 4 by 5 to 2 by 2.5\degr resolution, however they continue at lower resolution to save computational time.
      ...
      Many models lack in-situ measurements with which to verify their chemical mechanisms, leading to large discrepancies, as seen in \citet{Marvin2017a}.
      TODO: briefly talk about Marvin2017a takeaways.
      \citet{Christian2017} used GEOS-Chem v9-02, with $4^{\circ} \times 5^{\circ}$ resolution, and while the low resolution adds errors in OH concentrations and O$_3$ production rates, the errors from chemistry, meteorology, and emissions are much larger.
    ...
    \subsubsection{Chemistry mechanisms}
      ...
      \citet{Christian2017} found that GEOS-Chem ozone was most sensitive to NO$_2$ photolysis, the $NO_2 + OH$ reaction rate, and various emissions.
      ...
      Recently \citet{Marvin2017} compared five global ACMs isoprene mechanisms by evaluating simulated HCHO mixing ratios compared to in situ measurements from the Southeast Nexus (SENEX) aircraft campaign (in southeastern USA).
      ...
      \citet{Travis2016} show how modelled surface ozone is overestimated due to high estimates of NO$_X$ emissions, which affect oxidative capacity and VOC reactions.
      ...
      \citet{Mao2012} showed how traditional OH measurements may be overestimated due to VOC oxidation.
      ...
      \citet{Nguyen2014} also see this VOC oxidation interference in measurements using a gas chromatographer (GC) with an equipped flame ionisation detector (FID).
      This lends more credence to the current understanding of VOC oxidation as it closed the gap between measurements and model predictions \citep{Mao2012}.
    ...
    \subsubsection{Soil Moisture}
      ...
      \citet{Rowntree1983} show how quickly soil moisture anomalies affect rainfall and other weather systems, while \citet{Chen2001} specifically show how important fine scale soil moisture information is when modelling land surface heat flux, and energy balances.
      ...
      Droughts affects can be difficult to measure, as it is a multi-scale problem which affects various aspects of the land-air interface including plant emissions and dry deposition \citep{Wang2017}.
      The Standardised Precipitation Evapotranspiration Index (SPEI) is a measure of drought using TODO \citet{SPEI_website}.
      This product covers 1901 - 2011, and uses the average over that period as the background, in order to compare drought stressed regions against those with sufficient or excess water \citet{SPEI_website}.
...
\label{LR:Aus}
  ...
  % More uniqueness
  \citet{Guenther2006} estimated that the Australian outback is among the worlds strongest isoprene emitters with forests in SE Australia having emission factors greater than 16 mg m$^{-2}$ h$^{-1}$ (see figure \ref{LR:Aus:fig_MEGAN_EF}).
  Measurement campaigns in SE Australia have since cast doubt on the emission factors used by MEGAN, as the Eucalyptus trees and soil moisture were poorly studied \citet{Emmerson2016}.
  ...
  \subsection{Ozone}
    ...
    Generally STT over australia affects the upper troposphere only, however ozone enhancements can reach quite low during heavy storms and cyclonic weather patterns \citep{Alexander2013}.
  
  % voc estimates
  \subsection{VOCs}
  
    % Australia could be a VOC hotspot
    Australia has the potential to be a major hotspot of isoprene emissions according to \citet{Guenther2006,Guenther2012}, which shows heavy emissions factors in the region.
    ...
    With monoterpenes also being poorly estimated \citep{Winters2009,Emmerson2016,}.
    ...
    \citet{Muller2008} show how isoprene is poorly captured by the MEGAN model and analyse the affect of changing the soil moisture parameter.
    \citet{Sindelarova2014} show reductions in modelled Australian isoprene emissions of 50\% when incorporating soil moisture in MEGAN estimates. 
    ...
    Some Eucalypt emissions are based on samples from young trees, which may emit more isoprene than older trees \citep{Emmerson2016}.
    ...
    Over Australia MEGAN suffers from unpublished plant functional types and their emissions \citep[e.g. ]{Muller2008}.
    ...
    Isoprenoid emissions remain to be verified in Australia and monoterpene emissions are 2-4 times too low \citep{Winters2009,Emmerson2016}.
    ...
    \citet{Emmerson2016} analyse EF sensitivity of a high resolution model of atmospheric chemistry over southeast Australia, comparing isoprene and monoterpene emissions against 4 separate campaigns.
    ...
    \citet{Emmerson2016} suggest that monoterpenes may be emitted in similar quantites to isoprene, with more measurements required to determine if this is so.
    ...
    As HCHO are produced with relatively high yield after isoprene is emitted, satellite measurements of HCHO can allow us to estimate isoprene emissions \citep[e.g.]{Palmer2001, Millet2006, Bauwens2016}.
