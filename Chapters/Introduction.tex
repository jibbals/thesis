...
\label{LR:HCHO}
  ...
  \subsection{Measurement techniques}
    ...
    \subsubsection{Satellite measurements}
      ...
      \begin{itemize}
        \item  The ERS-2 launched in April 1995 which houses the GOME ultraviolet and visible (UV-Vis) spectrometer
        \item The AURA launched in July 2004 which houses the OMI UV-Vis spectrometer
      ...
      Different satellites, instruments, or techniques which measure HCHO (or any trace gas) can give different results due to differing a priori assumptions or applied calculations \parencite{Lorente2017}.
      The concept of differences which arise between datasets based on measurement techniques or underlying instrument biases is called structural uncertainty.
