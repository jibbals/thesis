...
\label{LR:Atmos}
  ...
  \label{LR:Atmos:Chem}
    ...
    %\label{LR:Atmos:Chem:radicals}
      ...
      Ozone is also important for nitrate radical formation in the troposphere through photolysis in the presence of water.
...
\label{LR:O3}
  ...
  However around 11\% of the total column of ozone is located in the troposphere (TODO: cite).
  ...
  Generally there are two main drivers of tropospheric ozone concentrations; transport from the stratosphere and creation due to biogenic emissions of precursors. 
  At smaller (regional) scales, pyrogenic and anthropogenic emissions are also important.
  In large cities such as Sydney, NO$_X$ emissions from traffic and power production can impact ozone concentrations.
