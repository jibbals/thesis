...
\label{LR:Atmos}
  ...
  The pressure we are subjected to is from the weight of all the air above us.
  ...
  \label{LR:Atmos:Struct}
    ...
    % Boundary layer
    In addition to these atmospheric layers, it is helpful to split the troposphere further: into a \textit{boundary layer}, and the \textit{free troposphere}.
    ...
    It generally extends anywhere from 200 - 1000~m, above which the ground affects have less direct impacts.
  ...
  \label{LR:Atmos:Chem}
    ...
    %\label{LR:Atmos:Chem:radicals}
      ...
      Over land, isoprene (C$_5$H$_8$) and monoterpenes (C$_{10}$H$_{16}$) account for 50\% and 30\% of the OH reactivity respectively \citep{Fuentes2000}.
      ...
      Ozone is an important precursor to OH, as excited oxygen atoms (O(${}^1$D) are created through its photolysis, which then go on to mix with water and form OH, as shown in this equation taken from \cite{Atkinson2000}:
      \begin{equation}
      \begin{aligned}
    ...
    \subsubsection{NOx}
      NO$_X$ ($\equiv $ NO$_2$ and NO) is another important group in the atmosphere due to the various reactions it initiates.
