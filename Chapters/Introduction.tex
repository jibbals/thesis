...
\label{LR:Aus}
  ...
  \subsection{VOCs}
    ...
    Bottom up inventories of VOCs remain largely uncertain due to missing or extrapolated plant functional type information, changing land cover, and parameterised environmental stressors \parencite{Guenther2000,Kanakidou2005,Millet2006}.
    Isoprene is one of the most important VOCs, and is poorly captured by MEGAN \parencite{Muller2008, Sindelarova2014, Emmerson2016}.
    Australia has a much greater diversity of tree species than is represented by MEGAN, however sparse measurements of emissions and VOC concentrations makes model improvement difficult.
    ...
    The complex and parameter sensitive reactions involved in VOC emissions and subsequent chemistry make model validation even more valuable in this area.
  ...
  \subsection{Measurements}
    ...
    There are relatively few measurements in the southern hemisphere, including MUMBA \parencite{PatonWalsh2017}, SPS \parencite{Dunne2018}, and an instrument at the Wollongong university (see Section \ref{Model:datasets:wollongong_ftir}).
    ...
    The instrument at Wollongong university provides 20 years of DOAS calculated HCHO measurements from a solar spectrometer, which is the only long term HCHO vertical column measurement comparable to satellite data available. 
