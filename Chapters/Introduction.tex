...
\label{LR:Aus}
  ...
  \subsection{Measurements}
    ...
    Satellite total columns suffer from orography amongst other limitations when compared to this data. % could cite john demol thesis but can't find it on uow's great library website \parencite{Demol2010}.
