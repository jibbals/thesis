...
\label{LR:Atmos}
  ...
  \subsection{Radiative Forcing}
    ...
    VOC emissions affect ozone along with several atmospheric parameters which directly and indirectly alter radiative forcing rates \parencite[e.g.][]{Arneth2008}.
...
\label{LR:VOCs}
  ...
  Some PM comes from small organic aerosols (OA) which are directly emitted to the atmosphere in the particulate phase. 
