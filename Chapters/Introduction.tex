...
\label{LR:Models}
  ...
  \subsection{Emissions}
    ...
    MEGAN has estimated $\sim 1150$\tgcpyr ~BVOC emissions globally, of which 
    $\sim$465-532\tgcpyr ($\sim{50-70\%}$) is isoprene \parencite{Guenther2006, 
    Messina2016, Sindelarova2014}. 
