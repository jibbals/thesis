...
\label{LR:VOCs}
  ...
  \subsection{Emissions}
    ...
    % JENNY TODO: Some redundancy with previous paragraph. I would suggest you 
    %get rid of the first sentence in the previous paragraph as it makes more 
    %sense to put the numbers here.
    ...
    tropical trees. 
    The main VOCs emitted are isoprene (C$_5$H$_8$) ($\sim50\%$), and 
    monoterpenes (C$_10$H$_16$) ($\sim30\%$), which have different emission 
    amounts depending on the tree species. 
  ...
  \label{LR:VOCs:Isop}
    ...
    ~($\sim 527$\tgpyr ~isoprene), has been made using a completely different 
    model \parencite{Messina2016}.
  ...
  \subsection{Isoprene chemistry}
    ...
    \end{equation}
    The many children processes and products that begin with isoprene oxidation 
    ...
    \subsubsection{Low NOx pathway}
      ...
      \textcite{Paulot2009b} estimated that $95 \pm 45$\tgpyr ~of IEPOX was 
      being created in the atmosphere, which (at the time) was not modelled by 
      CTMs.
...
\label{LR:HCHO}
  ...
  \subsection{Sources and sinks}
    ...
    %Background hcho
    Background levels of HCHO in the atmosphere are driven by the oxidation of 
    methane (CH$_4$) by the hydroxyl radical (OH$\dot{}$), which produces $\sim 
    970$\tgpyr ~\parencite{FortemsCheiney2012}.
    ...
    Many of the HCHO yields from terpenoids are estimated through chamber 
    studies that examine molecular mass and charge after mixing the compound of 
    choice into a known volume of air \parencite[e.g.,][]{Nguyen2014}.
    ...
    Nowadays HCHO concentrations are better understood, however precursor 
  ...
  \subsection{Measurement techniques}
    ...
    factors and water profiles \parencite[e.g.,][]{Franco2015}.
    ...
    \subsubsection{Satellite measurements}
      ...
      This can be done using air craft data such as from the SEAC$^4$RS HCHO 
      measurements over the southeastern US to provide model validation 
...
\label{LR:Models}
  ...
  \subsection{Emissions}
    ...
    Models use these properties of the emitters in order to estimate how much 
    isoprene is being produced \parencite[e.g.,][]{Guenther1995,Guenther2006}.
...
\label{LR:Aus}
  ...
  \subsection{Biogenic VOCs}
    ...
    Over Australia MEGAN suffers from a lack of studied plant functional types 
    and their emissions \parencite[e.g.,][]{Muller2008}.
  ...
  \subsection{Measurements}
    ...
    %and Tumbarumba \parencite{Emmerson2016}
