...
\label{LR:O3}
  ...
  \subsubsection{Stratosphere to troposphere transport}
    ...
    The proportion was revised down to around 10\% over the years as measurement and modelling campaigns improved \replaced[id=mh]{our}{scientists} understanding of global scale transport, mixing, and chemistry \parencite{Guenther2006, Monks2015}.
...
\label{LR:VOCs}
  ...
  \added[id=tb]{These properties are largely dictated by the chemical makeup of the individual compounds. A compound's atmospheric lifetime is strongly related to its reactivity (and the concentration of reactants), with more reactive compounds having shorter atmospheric lifetimes.}
  ...
  \added[id=tb]{Other major emission sources of VOC (anthropogenic and pyrogenic) are also important.}
  ...
  \added[id=tb]{This thesis mostly focuses on biogenic emissions, with influences from pyrogenic and anthropogenic emissions removed (Section \ref{Model:filter}).}
  ...
  % JENNY NOTE: There is a lot of redundancy here, both within this section and with the stuff that comes in a few sentences when you start talking about SOA. I think you do it better below and I would suggest just moving the relevant references and then deleting most of this. You would then go directly from VOC oxidation to ozone production which makes more sense anyway.
  ...
  % No concentration causing net loss or gain of O3, through VOC degradation products
  ...
  \subsection{Emissions}
    ...
    Many of these estimates come from Model of Emissions of Gases and Aerosols from Nature (MEGAN), a bottom-up biogenic emissions model.
  ...
  \subsection{Biogenic emissions modelling}
    ...
    \added[id=tb]{Biogenic emissions models generally take what is termed a bottom up approach, where the environment is simulated and then the emissions from that environment is estimated based on its interaction with the weather. 
    The most important parameters dealing with VOC emissions are leaf area index, emission factors, plant functional type, and light density fraction \parencite{Messina2016}.
    The estimated emission factors are built up from measured plant emissions, which can be measured from downwind \parencite[e.g.,][]{Nguyen2014} or from within a chamber \parencite[e.g.,][]{Paulot2009b,Nguyen2014}.
    ...
    %% Brief intro to MEGAN
    %\added[id=tb]{MEGAN is frequently referred to throughout this thesis and therefor is briefly introduced here. 
    %  MEGAN was created and published by \parencite{Guenther1995}, with subsequent updates in \textcite{Guenther2000, Guenther2006, Guenther2012}.}
    ...
    Relatively few Australian species are used within MEGANs plant functional type parameterisations, and those that are listed may be poorly represented \parencite{Emmerson2016}.
    This leads to increased uncertainty for Australian emissions.
    Additionally there is uncertainty around the soil moisture parameterisations, with soil moisture poorly understood in Australia \parencite{Sindelarova2014, Emmerson2019}.
  ...
  \label{LR:VOCs:Isop}
    ...
    Australia has increased uncertainty (relative to globally) due to its lack of measurements and study  (see Section \ref{LR:VOCs:models}).
...
\label{LR:Models}
  ...
  Models can fill the gaps (both spatial and temporal) in measurement records, and\deleted[id=mh]{ can help us} improve\replaced[id=mh]{ peoples}{ our} understanding of the natural world.
  ...
  \subsection{Emissions}
    ...
    \end{equation}
    with $A$ the activity rate, $EF_i$ being the emission factors, and $S_i$ is a scaling factor accounting for meteorology and other effects not included in $A$ or $F$ (e.g., seasonal temperature).
    ...
    For example, GOME satellite HCHO and a Beyesian inversion technique have been used to estimate isoprene emissions of $\sim566$\tgcpyr ~globally 
    \parencite{Shim2005}. 
...
\label{LR:Aus}
  ...
  \subsection{Ozone}
    ...
    This affects\replaced[id=mh]{ scientists}{ our} ability to accurately determine sources of ozone in the troposphere, with current southern hemisphere trends lacking full explanation \parencite{Zeng2017}. 
...
\label{LR:Gaps}
  ...
  \added[id=mh]{Several layers of knowledge are required to accurately estimate ozone concentration in the troposphere, with the most important being emissions of precursors, transport from the ozone rich stratosphere, and chemical processes in both clean and polluted air masses.
    ...
    Improvements to emissions models require improved understanding of emissions from Australian vegetation and how they respond to meteorological and chemical parameters.
    How Australian tropospheric ozone concentrations are affected by ozone transported from the stratosphere is also unclear, with the main factor being a lack of knowledge around how frequently a transport event occurs, and the quantity of ozone transported by any such event.
    Finally due to the complex nature of atmospheric chemistry involving isoprene and other BVOCs, it is not immediately clear how sensitive ozone concentrations in the atmosphere are to changes in BVOC emissions.
    }
...
\label{LR:Aims}
  ...
  Combining satellite data with model outputs provides a platform for the understanding of natural processes\removed[id=mh]{, which are uncertain over Australia}.
