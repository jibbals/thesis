...
\label{LR:VOCs}
  ...
  \subsection{Emissions}
    ...
    This estimate is decreases simulated OH concentrations by $\sim10\%$, to 9.5e5 molec cm$^{-3}$.
  ...
  \subsection{Isoprene chemistry}
    ...
    \subsubsection{Oxidation}
      ...
      This OH adduct then reacts with O$_2$ to produce ISOPOO, which can be any of six different isomers \parencite{Patchen2007}.
      ISOPOO react with HO$_2$ or NO and produce stable products (often called oxidised VOCs or OVOCs).
      Oxidation reactions are important and quickly stabilise the ratio of NO to NO$_2$.
      
      Ozonolysis is another oxidation pathway for volatile alkenes, involving the splitting of carbon chains by ozone molecules \parencite{Nguyen2016}.
      This process also leads to HCHO, with yields depending on reactions following isoprene ozonolysis.
      TODO: other oxidation pathways of note...
      ...
      There is uncertainty about which pathways are most important following ISOPOO production, which carries through to predictions by atmospheric models \parencite{Nguyen2014}.
      This limits understanding of the relative importance of some chemical processes such as TODO example %TODO: example chemical process with \roo \parencite{Crounse2013}.
      ...
      Most of these reaction pathways produce HCHO, however products including HCHO, methyl vinyl ketone (MVK), and methacrolein (MCR) are formed at different yields between the two pathways \parencite{Marais2012, Liu2016a, Wolfe2016}.
    ...
    \subsubsection{High NOx pathway}
      ...
      Any organic nitrates which are formed affect levels of both HO$_X$ (H, OH, peroxy radicals) and NO$_X$, generally acting as a sink \parencite[][and references therein]{Mao2013}.
      A portion of the organic nitrates are recycled back to NO$_X$, serving as a reservoir of nitrogen and allow its transport to the boundary layer of remote regions \parencite{Patchen2007,Paulot2009a,Lu2016}.
    ...
    \subsubsection{Low NOx pathway}
      ...
      It was thought that in low NO environments, like those far from anthropogenic pollution and fires, oxidation of isoprene would create ISOPOOH and reduce local concentrations of OH and HO$_2$ \textcite{Guenther2000,Paulot2009b}.
      ...
      HO$_X$ is recycled through dihydroxyperoxides (IEPOX), formed from ISOPOOH oxidation, and some HO$_X$ is produced in the formation of MCR and MVK \parencite{Paulot2009b}.
      ...
      \textcite{Paulot2009b} used GEOS-Chem, modified to include IEPOX formation, to estimate that one third of isoprene peroxy radicals react with HO$_2$, and two thirds react with NO. 
      In low NO$_X$ environments, ISOPOOH is formed in yields $> 70\%$, while MCR and MVK is formed with yields $< 30\%$ \parencite{Paulot2009b}.
      ...
      Due to OVOC interference, measurements in low NO$_X$ environments can lead to massively overestimated MVK and MCR yields \parencite{Nguyen2014}.
      ...
      %% MVK and MCR yields each increase (due to interference by OVOCs) to greater than 40\% when directly sampled by GC-FID.
...
\label{LR:Models}
  ...
  \label{LR:Models:Uncert}
    ...
    \subsubsection{Soil Moisture}
      ...
      MEGAN can account for soil moisture by applying it as an emission factor which scales the emission rate of various species.
...
\label{LR:Aus}
  ...
  \subsection{VOCs}
    ...
    Emission rates from various species of eucalypt and other flora are highly complex, depending on current and recent weather, temperature, tree age, health, etc. \parencite{Guenther2012}. 
