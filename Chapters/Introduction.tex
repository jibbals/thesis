...
\label{LR:O3}
  ...
  A summary of processes affecting tropospheric ozone, copied from \cite{Young2018}, is shown in Figure \ref{LR:O3:YoungOzoneSummary}.
...
\label{LR:VOCs}
  ...
  This occurs through the following reaction sequence: TODO: \cite{Sillman1999} % TODO cite  \url{http://www-personal.umich.edu/~sillman/web-publications/Sillmanreview99.pdf}
  \begin{equation}
    \begin{aligned}
