...
\label{LR:O3}
  ...
  \subsection{Stratosphere to troposphere transport}
    ...
    There are a few methods of doing this, such as \cite{Ojha2016}, who use the a model that keeps track of ozone formed in (and transported from) the stratosphere.
