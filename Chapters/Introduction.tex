...
\label{LR:VOCs}
  ...
  \subsection{Isoprene chemistry}
    ...
    \subsubsection{Oxidation}
      The primary first step for atmospheric isoprene is photooxidation, reacting with OH to form isoprene hydroxyperoxy radicals (\roo or ISOPOO) \parencite{Wolfe2016,Marvin2017,Patchen2017}.
      ...
      NO$_X$ concentrations have a lead role in what reactions take place after ISOPOO is created, with high-NO$_X$ and low-NO$_X$ pathways producing different chemical products at different yields.
      The portion of ISOPOO that reacts with NO or HO$_2$ is used to determine which pathway isoprene oxidation is following.
      ISOPOO predominantly reacts with NO (forming ISOPN) in the high-NO$_X$ pathway, or with HO$_2$ (forming ISOPOOH) in the low-NO$_X$ pathway \parencite{Yu2016}.
