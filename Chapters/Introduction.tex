  ...
  \subsection{Stratospheric ozone}
    ...
    \begin{equation}
      \begin{aligned}
        ...
        \text{O}_3 + hv              & \to \text{O}+\text{O}_2   && \lambda < \added[id=tb]{320} \text{nm} \\
    ...
    The lifetime of O against loss by O$_2$ is less than a second in the troposphere, and produced O$_3$ quickly returns to O and O$_2$, as \replaced[id=tb]{lower energy ($\lambda < 1180$~nm) photons are abundant}{low energy ($\lambda < 1180$~nm) photons and M are abundant}.
...
\label{LR:VOCs}
  ...
  \subsection{Emissions}
    ...
    %\end{quote}
    MEGAN parameterises BVOC emissions as a function of temperature, land cover, plant functional type, etc., with descriptions given in \textcite{Guenther2012}.
  ...
  \label{LR:VOCs:Isop}
    ...
    MEGAN \parencite{Guenther1995}, and subsequent updates \parencite{Guenther2000, Guenther2006, Guenther2012}, have been used throughout the atmospheric community to make global estimates of isoprene emissions, at roughly 500-600\tgpyr, emitted mostly during the day.
    Other models also exist which estimate similar isoprene amounts, such as LPJ-GUESS (Lund-Potsdam-Jena General Ecosystem Simulator) \parencite{Arneth2007}, and ORCHIDEE (Organising Carbon and Hydrology in Dynamic EcosystEm) \parencite{Messina2016}.
    There is a potential issue caused by shared underlying algorithms and assumptions between the models, which lead to an unrealistic convergence on isoprene emission estimation \parencite{Arneth2008}.
    ...
    Due to the highly reactive nature of isoprene, modelling of related chemical products is sensitive to uncertainties, for example the diurnal pattern of isoprene emissions affects modelled ground level ozone \parencite{Hewitt2011, Fan2004}.
