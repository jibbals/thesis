...
\label{Model:Datasets}
  ...
  \subsection{Satellite}
    ...
    \subsubsection{OMHCHO}
      ...
      Slant columns range from $\sim 4\times 10^{15} $ to $\sim 6 \times 10^{16}$\moleccm, with uncertainties from 30\% (larger columns) to over 100\% (smaller columns) \citep{Abad2015}.
