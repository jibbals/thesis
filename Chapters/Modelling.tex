...
\section{GEOS-Chem}
  ...
  \subsection{Chemical Mechanism}
    ...
    \ce{
      ...
      RIO2 + MCO3 ->[1.68*10^{-12} \exp{(500/T)}] & .887HO2 + \highlight{.747HCHO} + .453MVK \\
        ...
        & + CO2 + MO2 \\
      RIO2 + MCO3 ->[1.87*10^{-13} \exp{(500/T)}] & MEK + ACTA \\
    }
  ...
  \subsection{GEOS-Chem isoprene}
    ...
    The primary oxidation pathway of isoprene is reaction with the OH radical ($ISOP + OH \to ISOPOO$).
    Following are seven potential \roo reactions (RIO2 in \ref{Model:GC:Mechanisms:eqn_mechanisms}), depending on reactant concentrations and local temperature.
    ...
    Formation of isoprene nitrates (ISOPN) affect ozone levels through NO$_X$ sequestration, and the yields and fate of these nitrates was analysed in \textcite{Paulot2009a}.
