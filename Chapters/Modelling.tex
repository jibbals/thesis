...
\section{Recalculation of OMI HCHO}
  ...
  \subsection{Difference between original and corrected OMI HCHO columns}
    ...
    \mypicw{0.75\textwidth}{Figures/OMI_link/N_pix_comparison.png}{%
      ...
      $N_{GC}$ refers to the number of pixels used in AMF recalculation without running code from Paul Palmer, $N_{PP}$ refers to those which have been recalculated using their code.
...
year   ,   pixels    ,  fire               ,    anthro            ,  smoke           ,    all 
  ...
  \subsection{Pyrogenic filter}
    ...
    Vertical column amounts (at \highhr ~resolution) averaged over January, 2005, and the pixel counts are shown side by side.
    ...
    \mypic{Figures/OMI_link/VCC_fires_20050301-20050331.png}{% 
      TODO: Update this plot to just really examine fire filtering effects.
      Column 1: $VCC_{PP}$ amounts after applying the active fire filter.
      Column 2: Pixel counts after applying the active fire filter.
      ...
      The average number of pixels per land square is inset as text in column 1.
