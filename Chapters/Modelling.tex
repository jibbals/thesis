...
\section{Calculating an AMF}
  ...
  % JENNY COMMENT: Spell out here to remind reader. Also start with a reminder of where/why the AMF is needed (remember you have just been talking about modelling, so it's not clear that you are switching back into describing satellite product stuff)
  % What is AMF again?
  ...
  % JENNY COMMENT: Would be better to introduce the vertical coordinate systems when you discuss the model (including this statement), then just briefly remind the reader here what the coordinate system is
