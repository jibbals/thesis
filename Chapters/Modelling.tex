  ...
  \subsection{Campaign datasets}
    ...
    \label{Model:datasets:wollongong_ftir}
      ...
      \mypic{Figures/OMI_link/FTIR_midday_AK.png}{%
        ...
        TODO: add x-axis label (Averaging kernal [unitless])
...
\label{Model:omhcho}
  ...
  \label{Model:omhcho:pixel_filtering}
    ...
    \mypic{Figures/AusOMHCHO_Hist_20130318_final.png}
    {
      ...
      TODO: add x-axis label (molec cm-2).
  ...
  \subsection{Uncertainty}
    ...
    \mypic{Figures/OMI_link/Uncertainty_OMI_200501.png}{
      ...
      TODO: combine colour bars on top,bottom
...
\section{Process schematic}
  ...
  As described in this chapter, satellite and modelled data is combined combined to form recalculated corrected vertical columns (VCC), with masks created for potential anthropogenic, pyrogenic, and smearing influence.
  The end product is a gridded data file which contains new and old satellite and modelled vertical columns, along with sundry data to allow uncertainty calculation and other analyses.
...
\begin{description}
  ...
  \item[SPS] Measurements of trace gases relevant to air quality in Western Sydney, Australia, from May 2016 to September 2017 as part of the Western Air Shed and Particulate Study for Sydney (WASPSS) \parencite{SPS2017}. 
