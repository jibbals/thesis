...
\section{GEOS-Chem}
  ...
  \subsection{Outline}
    ...
    Meteorological fields are driven by NASA's GEOS-5 data (0.5$^{\circ}$ x 0.666$^{\circ}$) \parencite{Chen2009}, which exists up to 2013. %, or GEOS-FP data (0.25$^{\circ}$ x 0.3125$^{\circ}$).
...
% TODO Move stuff from here upwards into GEOS-Chem section
