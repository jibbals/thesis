...
\label{Model:Analysis}
  ...
  \label{Model:Analysis:HCHO}
    ...
    In each region the positive highly correlated data is roughly as expected from (TODO: cite and example studies).
    
    \begin{figure}
      \includegraphics[width=\textwidth]{Figures/HCHO/GClink/HCHO_vs_temp_SEA_20050101.png}
      \caption{%
        ...
        Grid boxes from south-eastern Australia are used, as shown in the top panel.
      }
      \label{Model:Analysis:HCHO:fig_hcho_vs_temp_SEA_200501}
    \end{figure}
    
    \begin{figure}
      \includegraphics[width=\textwidth]{Figures/HCHO/GClink/HCHO_vs_temp_NA_20050101.png}
      \caption{%
    ...
    \begin{figure}
      \includegraphics[width=\textwidth]{Figures/HCHO/GClink/HCHO_vs_temp_SWA_20050101.png}
      \caption{%
