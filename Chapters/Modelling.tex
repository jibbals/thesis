...
\section{GEOS-Chem}
  ...
  \label{Model:GC:NOx}
    ...
    Conversion to nitric acid (HNO$_3$) followed by deposition is the primary removal mechanism \parencite{Delmas1997, Ayers2006}.
    Anthropogenic emissions come from the Emissions Database for Global Atmospheric Research (EDGAR), for more details visit \url{http://wiki.seas.harvard.edu/geos-chem/index.php/EDGAR_v4.2_anthropogenic_emissions}.
...
\section{Recalculation of OMI HCHO}
  ...
  \subsection{Difference between original and corrected OMI HCHO columns}
    ...
    % TODO: Omega regressions if they show anything?
...
\section{Filtering Data}
  ...
  \subsection{Pyrogenic filter}
    ...
    % TODO: just look at fire filtering affects .. VCC vs number of days of active fires removed
