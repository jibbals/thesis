...
%    {\label{Model:analysis:NOx:fig_GC_vs_OMI_soil_Spr}}
  ...
  \subsection{GEOS-Chem simulations}
    ...
    \subsubsection{UCX vs tropchem}
      ...
      Overall the UCX mechanism and increased vertical resolution lead to slightly higher isoprene and HCHO, and slightly lower ozone in the near the surface over Australia.
  ...
  %TODO Move this stuff to AMF calculation or FTIR calculation section? or somewhere better  
...
\section{Recalculation of OMI HCHO}
  ...
  \subsection{Creating new shape factors}
    ...
    The shape factor is calculated using GEOS-Chem midday output (see Section \ref{Model:GC:simulations:outputs}) which provide simulated HCHO concentration profiles ($\eta(z)$) and total columns ($\Omega$) at 2x2.5\degr horizontal resolution.
