...
\section{Measurement techniques}
  ...
  \subsection{Satellites}
    ...
    Soon even more satellite data will be available in the form of geostationary satellite measurements (\textcite{Kwon2017}).
...
\label{Model:omhcho}
  ...
  \subsection{OMI}
    ...
    This band of wavelengths allows measurements of trace gases including O$_3$, NO$_2$, SO$_2$, HCHO, and various other quantities like surface UV radiation.
...
\label{Model:Datasets}
  ...
  This section examines the other data sets used in this thesis.
