...
\section{Filtering Data}
  ...
  \subsection{Anthropogenic filter}
    ...
    \mypic{Figures/OMI_link/OMNO2_threshaffect_2005_final.png}{%
...
\section{Relationship between temperature and HCHO}
  ...
  In this thesis the pyrogenic filter is applied at the higher horizontal resolution (\highr), and this analysis suggests that the filter should strengthen the relationship between total column HCHO and its biogenic precursors over Australia.
