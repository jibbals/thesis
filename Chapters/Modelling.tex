...
\section{Datasets}
  ...
  \label{Model:datasets:satellite}
    ...
    \subsubsection{Nitrogen dioxide}
      ...
      \mypic{Figures/OMNO2d_2005m0129.png}{%
        Example of NO$_2$ tropospheric columns taken from the OMNO2d product.
  ...
  \subsection{Model datasets}
    ...
    \subsubsection{Surface temperatures}
      ...
      \mypicw{.5\textwidth}{%
        Figures/CPC_Temperature_EG.png}{CPC daily maximum temperature dataset output for 1, Jan, 2005.
  ...
  \subsection{Campaign datasets}
    ...
    % Figure from ??
    % TODO: Remove HIPPO overset image...
    \mypic{Figures/campaigns/campaign_locations.png}{%
      Locations of VOC measurements (top panel) and ozonesonde release sites (bottom panel). 
      Inlaid in top panel is the flight paths over Australia of the HIPPO campaign.
...
\label{Model:omhcho}
  ...
  \label{Model:omhcho:pixel_filtering}
    ...
    %Filtering
    After being read, pixels are filtered by solar zenith angle (SZA) and latitude, similarly to other works \parencite[e.g.,][]{Marais2012, Barkley2013, Bauwens2016, Zhu2016}.
  ...
  \label{Model:omhcho:amf}
    ...
    Two examples of this are GOME-2 (on the MetOp-A satellite) products, %(\url{http://atmos.caf.dlr.de/gome/product_hcho.html}), 
  ...
  \subsection{Uncertainty}
    ...
    \mypic{Figures/OMI_link/Uncertainty_OMI_200501.png}{
    ...
    \subsubsection{GEOS-Chem outputs}
      ...
      \begin{description}
        \item[Midday output]%
          ...
          This is done by setting up a latitude by longitude array which matches the horizontal resolution of the data, filling each grid box with its local time offset.
