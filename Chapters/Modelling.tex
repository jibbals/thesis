...
\section{GEOS-Chem}
  ...
  \subsection{Overview}
    ...
    Anthropogenic VOC emissions come from the EDGAR inventory, while biogenic VOC emissions are simulated using the MEGAN model (see section \ref{Model:GC:MEGAN}).
