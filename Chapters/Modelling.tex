...
% NEED TO STRUCTURALLY FIX 2.2 up to 2.3, 
...
\section{Datasets}
  ...
  \label{Model:Datasets:satellite}
    ...
    \subsubsection{OMAERUVd}
      ...
      OMAERUVd provides a useful dataset which allows detect areas which may be smoke affected.
  ...
  \subsection{Model datasets}
    ...
    \subsubsection{CTM output}
      ...
      GEOS-Chem model output is used extensively in this thesis and is discussed in more detail in section \ref{Model:GC:simulation:outputs}.
      These output are resolved to 47 vertical levels from the ground up to 0.01~hPa, at 2x2.5\degr horizontal resolution.
  ...
  \subsection{Campaign datasets}
    ...
    In this thesis we assume uncertainty in this product is as estimated (15\%).
...
\label{Model:omhcho}
  ...
  One more filter is applied before any other calculations are applied, which filters unreasonable column amounts.
  ...
  This has been done previously in TODO %TODO: find which paper did this.
...
\section{GEOS-Chem}
  ...
  \subsection{GEOS-Chem simulations}
    ...
    \subsubsection{UCX vs tropchem}
      ...
      \mypic{Figures/OMI_link/GC/UCX_vs_trp_middaysurf_20070101-20070228_OH.png}{Midday (1300-1400~LT) surface OH concentrations averaged over Jan-Feb, 2007. Absolute and relative differences are shown on the bottom row.}{\label{Model:GC:simulation:comparison:fig_UCXvsTrop_OH_surf_midday}}
...
\section{Recalculation of OMI HCHO}
  ...
  \subsection{Difference between new and old OMI HCHO columns}
    ...
    The AMF calculated using Dr. Palmer's produces TODO: MORE OR FEWER reasonable (within screening range of -5$\times 10^{15}$ to 1$\times 10^{17}$) vertical column amounts.
