...
\label{Model:Datasets}
  ...
  \subsection{Satellite}
    ...
    \subsubsection{OMAERUVd}
      ...
      % How I read the AAOD
      Gridded smoke AAOD is read from OMAERUVd at 1x1\degr resolution daily, and mapped to finer resolution using the nearest value for each gridsquare, before being saved along with the MOD14A1d fire product as seen in Figure \ref{Model:Datasets:OMHCHO:fig_flow_omhchorp}.
...
\section{Recalculation of OMI HCHO}
  ...
  Figure \ref{Model:omiRecalc:fig_flow_omhchorp} shows an overview of how this process is performed in my work.
