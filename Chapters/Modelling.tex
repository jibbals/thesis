...
year   ,   pixels    ,  fire               ,    anthro            ,  smoke           ,    all 
  ...
  \subsection{Pyrogenic filter}
    ...
    Active fires over the last 2, 4, and 8 days are filtered as the row number increases, with the first row showing VCC and pixel counts without applying the filter.
    ...
    \mypic{Figures/OMI_link/VCC_fires_200501.png}{% 
      ...
      Row 1-4: increasing number of prior days which have active fires are included when masking fire influence.
      The first row shows the values without applying any active fire filter.
      The average and maximum VCC column amount, and number of pixels, is inset as text in column 1 of each row.
