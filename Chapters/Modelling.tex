...
\section{Filtering Data}
  ...
  \subsection{Pyrogenic filter}
    ...
    \mypic{Figures/OMI_link/VCC_fires_200501.png}{% 
      ...
      Column 1: $VCC_{PP}$ amounts after applying the active fire filter at.
      The filter is applied at \highhr ~resolution, before output is averaged into \lowhr ~resolution.
