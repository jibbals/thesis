...
\section{Contributions and acknowledgements}
  ...
  \added[id=mh]{%
    All model runs, configuration, and alterations are performed by the Author, with initial instruction from Jenny Fisher.
    Satellite products are downloaded, collated, and (where appropriate) recalculated by the author.
