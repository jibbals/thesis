...
\section{GEOS-Chem}
  ...
  \subsection{GEOS-Chem isoprene}
    ...
    The mechanism was subsequently updated by \textcite{Mao2013}, who change the isoprene nitrate yields and add products based on \textcite{Paulot2009a, Paulot2009b}.
    %They used anion chemical ionization mass spectrometry (CIMS) to determine products of isoprene photooxidation.
    They used the yields and reactions of various positional isomers of isoprene nitrates, and their oxidation products, within GEOS-Chems suite of chemical mechanisms.
    ...
    \subsubsection{Oxidation}
      ...
      \textcite{Crounse2011} examined the isomerisations associated with the oxidation of isoprene to six different isomers of ISOPOO formed in the presence of oxygen.
      The primary oxidation pathway of isoprene is reaction with the OH radical ($ISOP + OH \to ISOPOO$) shown in equation \ref{mech_1}.
      Secondary oxidative pathways are from ozonolysis (Equation \ref{mech_2} and reaction with NO$_3$ (Equation \ref{mech_3}).
      These pathways are much slower but can be important in particular scenarios such as inside a pollution plume or after at night when NO$_3$ radicals can build up.
      ...
      Reactions \ref{mech_4} - \ref{mech_10} compete to determine the fate of \roo, which is often grouped into high or low NO$_X$ concentration pathways.
      
    
    \subsubsection{Nitrogen oxide impacts}
    
      % TODO split/fix/move this paragraph to following subsubsections
      ...
      High NO$_X$ has been defined as conditions where NO reactions are the main cause of losses for \roo (Reaction \ref{mech_5}) \parencite{Palmer2003}.
      ...
      NO$_X$ + HO$_2$ (Reaction \ref{mech_6}) produces mostly hydroxy hydroperoxides (RIP), and some HCHO.
      RIP can be oxidised (by OH) to produce epoxydiols, recycling OH \parencite{Paulot2009b}. 
      %($70\%$ yield of hydroxy hydroperoxides, ISOPOOH), 
      Isomerisation of \roo (Reaction \ref{mech_4}) largely produces HCHO, while recycling OH and producing HO$_2$.
      ...
      % UP TO HERE JENNY
      % High nox chemistry
      Under high NO$_X$ conditions, isoprene undergoes OH addition at the 1 and 4 positions, becoming $\beta$ (71\%) or $\delta$ (29\%) \roo, although these are not distinguished in the GEOS-Chem mechanism. 
    ...
    Isoprene chemistry in GEOS-Chem includes OH regeneration from oxidation of epoxydiols (not shown in Equation \ref{Model:GC:Mechanisms:eqn_mechanisms}) and slow isomerisation of \roo (Equation \ref{mech_4}) \parencite{Mao2013}.
  ...
  \subsection{Emissions from MEGAN}
    ...
    GEOS-Chem computes some emissions using predefined emission factor (EF) maps from MEGAN source code, and others using PFT maps and associated EF.
    ...
    MEGAN is itself a global model with resolution of around 1~km, which uses various inventories of parameters to estimate emissions.
    ...
    These parameters are globally estimated or measured using datasets including remote sensed satellite data.
    The various PFT and LAI are used to generate EF which represent quantities of a compound released to the atmosphere through an associated activity.
