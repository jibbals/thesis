...
\section{GEOS-Chem}
  ...
  \label{Model:GC:NOx}
    ...
    Simulated GEOS-Chem tropospheric NO$_2$ columns averaged from 13:00-14:00 local time (LT) are compared against OMNO2d data. %(Sec. \ref{Model:Datasets:OMNO2d}). 
    ...
    %The poor correlations for anthropogenic NO suggest that alterations over Australia would not lead to improved NO$_2$. 
