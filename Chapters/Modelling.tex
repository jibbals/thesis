...
\section{Calculating new AMF}
  ...
  Using the log of Beer's law (Equation \ref{LR:HCHO:DOAS:eqn_beerslaw}) we get 
  ...
  \end{equation*}
  We can then convert $\text{d}\tau$ to our path using Equation \ref{LR:HCHO:DOAS:eqn_tau} leading to
