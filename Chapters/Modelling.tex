...
\section{Filtering Data}
  ...
  \subsection{NOx}
    ...
    OMNO2d in 2005 is used to determine a suitable threshhold for anthropogenic influence by looking at NO$_2$ columns near several major cities in the south eastern sector of Australia.
    The mean, standard deviation, and time series over Australia of tropospheric NO$_2$ seen by Aura is shown in figure TODO.
    
    % Threshhold analysis
    The same regions as in figure TODO are shown again in figure TODO, with NO$_2$ pixels densities for each region shown, along with the determined threshold of TODO.
    This led to a reduction of TODO pixels, which removes TODO gridsquare days from the total available measurement space.
