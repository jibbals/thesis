...
\section{Measurement Techniques}
  ...
  The major sources of uncertainty in measurement techniques included interference from non-target compounds and under-reporting \parencite[eg.][]{Dunne2017,Guerette2018}.
  ...
  \subsubsection{Air mass factor (AMF)}
    ...
    This process is called deconvolution ($\Omega = AK \times VC_{satellite} + \times (I - AK) VC_{apriori}$) of the averaging kernal (AK) of the satellite instrument.
...
\label{Model:Datasets}
  ...
  \subsection{Model datasets}
    ...
    \subsubsection{CPC Temperatures}
      ...
      This data may be used to check the correlation between HCHO and temperature at a higher resolution than is provided by GEOS-Chem output.
      ...
      An example of one day of output is shown in figure \ref{Model:Datasets:fig_CPC_EG}.
