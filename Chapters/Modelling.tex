...
\section{Datasets}
  ...
  \label{Model:datasets:satellite}
    ...
    Level 3 data is a temporally and spatially aggregated subset of level 2 data, for instance monthly or yearly averages.
    ...
    \subsubsection{Nitrogen dioxide}
      ...
      OMNO2d is a gridded daily level three NO$_2$ product of satellite measurements averaged into 0.25\degrx0.25\degr ~horizontally resolved bins.
