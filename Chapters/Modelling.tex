...
%    {\label{Model:analysis:NOx:fig_GC_vs_OMI_soil_Spr}}
  ...
  \subsection{GEOS-Chem simulations}
    ...
    \subsubsection{GEOS-Chem outputs}
      ...
      GEOS-Chem in this thesis is run with a 15 minute time step for chemistry and 30 minutes for transport (TODO: check input.geos), at \lowhr horizontal resolution over 47 vertical levels.
