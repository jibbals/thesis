...
\section{Recalculation of OMI HCHO}
  ...
  \subsection{Binning the results daily}
    ...
    This takes around 90 minutes per day, and is parallelisable as each day is completely independent once the model has run in each required configuration.
