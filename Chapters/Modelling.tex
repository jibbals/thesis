...
\section{Recalculation of OMI HCHO}
  ...
  %TODO: point at figure showing columns with/without amf_pp
  The effect of not recalculating the $\omega_z$ is can be seen in figure TODO which looks at the altered satellite vertical columns using each method.
...
\section{Campaigns}
  ...
  \subsection{Sydney Particle Studies (SPS1, SPS2)}
    ...
    \mypic{Figures/GC_vs_Campaigns_20050131-20050601.png}{Comparison between GEOS-Chem HCHO concentrations in the gridsquare containing Sydney for the duration of the SPS 1 and 2 campaigns}{\label{Model:Campaigns:SPS:fig_GC_comparison}}

\section{Analysing output}
\label{Model:Analysis}
  
  \subsection{Satellite HCHO recalculations}
    %\label{satellite:recalc}
    %TODO: ref omhcho section
    The HCHO columns provided in OMHCHO are described in TODO: ref other section.
    ...
    %TODO figure comparing satellite hcho recalculations
    Figure (TODO: figure) shows vertical columns of HCHO for: column 1) the original satellite swaths, column 2) recalculated without changing the provided scattering weights, and column 3) fully recalculated vertical columns. 
    Each grid square (at 0.25 by 0.3125 lat lon resolution) has been created by binning the recalculated satellite pixels within the month.
