...
\section{Recalculation of OMI HCHO}
  ...
  \subsection{Reference sector correction}
    ...
    Modelled slant columns over the reference sector ($SC_{GEOS-Chem}$) are calculated by multiplying modelled vertical columns with the AMF calculated in prior sections using Equation \ref{Model:omiRecalc:eqn_AMFratio}: 
    \begin{equation*}
      SC_{GEOS-Chem} = \Omega_{GEOS-Chem} \times AMF
    \end{equation*}
