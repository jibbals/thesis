...
\label{Model:Datasets}
  ...
  \subsection{Aura}
    ...
    \subsubsection{OMI HCHO}
      ...
      Then a reference sector correction (RSC) is made (following \cite{Abad2016}), and a new AMF using a recalculated shape factor is calculated (AMF$_{GC}$).
      Finally the pixels are binned into a dataset I've called OMHCHORP. 
...
\section{Measurement Techniques}
  ...
  \label{Model:Meas:sat}
    ...
    These scattering functions are described in detail at (TODO:section? reference?).
