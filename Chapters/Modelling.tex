...
\section{GEOS-Chem}
  ...
  \label{Model:GC:Isop}
    ...
    \subsubsection{Emissions from MEGAN}
      ...
      Early models didn't account for abiotic stresses, such as drought, prior rainfall and development processes, although these influenced species specific emissions by more than an order of magnitude \parencite{Niinemets1999}.
      ...
      This is similar to isoprene emission estimates from MEGAN itself, of 400-600~Tg(C)yr$^{-1}$ \parencite{Guenther2006}.
      ...
      Using GOME satellite HCHO and a Beyesian inversion technique to derive isoprene emissions, \textcite{Shim2005} estimated global isoprene emissions to be $\sim566$~TgC yr$^{-1}$. 
      ...
      One of the important parameters in Australia is the soil moisture activity factor($\gamma_{SM}$), which can have large regional affects on the isoprene emissions \parencite{Sindelarova2014,Bauwens2016}.
...
\section{Filtering Data}
  ...
  \subsection{NOx}
    ...
    \begin{enumerate}
      \item Daily gridsquares with NO$_2$ greater than 10$^{15}$\moleccm2  are flagged as anthropogenic.
      \item After taking the yearly average over Australia, any gridsquares greater than $1.5 \times 10^{15}$\moleccm2 are flagged for the whole year.
    \end{enumerate}
    ...
    % Threshhold analysis
    The same regions as in figure \ref{Model:Filter:NOx:fig_omno2_timeseries} are shown again in figure \ref{Model:Filter:NOx:fig_omno2_densities}, with NO$_2$ pixels densities for each region shown, along with the threshold of $1 \times 10^{15}$\moleccm2.
    This led to a reduction of TODO gridsquares from the total available measurement space over Australia.
    The removal of gridsquares which went above the yearly averaged limit of 1.5e15\moleccm2 further reduced the available data by TODO gridsquares.
    ...
    \verb|Stats for  0 [-45, 108.75, -7, 156.25] k
    yearly mean:  5.832e+14
    std:  4.788e+14
    entries:  2429149
    gridsquares:  10541200
    
    Stats for  1 [-36, 148, -32, 153] red
    yearly mean:  1.128e+15
    std:  1.139e+15
    entries:  22829
    gridsquares:  116800
    
    Stats for  2 [-36, 134, -33, 140] green
    yearly mean:  5.866e+14
    std:  4.865e+14
    entries:  13385
    gridsquares:  105120
    
    Stats for  3 [-30, 125, -25, 135] cyan
    yearly mean:  4.808e+14
    std:  3.536e+14
    entries:  161271
    gridsquares:  292000
    
    Stats for  4 [-39, 142, -36, 148] darkred
    yearly mean:  1.216e+15
    std:  1.298e+15
    entries:  37463
    gridsquares:  105120
    
    Stats for  0 [-45, 108.75, -7, 156.25] k
    yearly mean:  4.602e+14
    std:  2.454e+14
    entries:  1925823
    gridsquares:  10541200
    
    Stats for  1 [-36, 148, -32, 153] red
    yearly mean:  5.441e+14
    std:  2.642e+14
    entries:  8809
    gridsquares:  116800
    ...
    a[a <= 0.0] = 1e-300
    Stats for  2 [-36, 134, -33, 140] green
    yearly mean:  4.450e+14
    std:  2.453e+14
    entries:  9777
    gridsquares:  105120
    
    Stats for  3 [-30, 125, -25, 135] cyan
    yearly mean:  4.194e+14
    std:  2.385e+14
    entries:  138701
    gridsquares:  292000
    
    Stats for  4 [-39, 142, -36, 148] darkred
    yearly mean:  5.216e+14
    std:  2.660e+14
    entries:  14421
    gridsquares:  105120
    |
