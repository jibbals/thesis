...
%Pixels removed by filtering: Number removed(portion removed(%%))
year   ,   pixels    ,  fire               ,    anthro            ,  smoke           ,    all 
  ...
  \subsection{Pyrogenic filter}
    ...
    \mypic{Figures/OMI_link/Filters/HCHO_vs_CPCtemp_20050101-20050228.png}{%
      HCHO vs CPC daily maximum temperatures TODO add longer caption.
    }{\label{Model:filter:fire:fig_HCHO_vs_CPC}}
