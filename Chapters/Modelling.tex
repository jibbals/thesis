...
%    \end{figure}
      ...
      \mypic{Figures/OMI_link/GC/NO_maps_2005.png}{%
        Left to right columns show tropospheric NO$_2$ columns (molec cm$^{-2}$) from GEOS-Chem, OMNO2d, and the differences.
...
%    \end{figure}
    ...
    \mypic{Figures/OMI_link/GC/NO_regressions_2005.png}{%
      The first column shows the scatter plots of tropospheric NO$_2$ columns between GEOS-Chem (x-axis) and OMNO2d at \lowhr.
