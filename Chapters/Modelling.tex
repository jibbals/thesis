  ...
  \subsection{GEOS-Chem simulations}
    ...
    \subsubsection{GEOS-Chem outputs}
      ...
      \begin{description}
        ...
        These are compared against ozonesonde releases (section \ref{Ozone:ModelComparison}) both over time and vertically.
    ...
    \begin{description}
      ...
      \begin{enumerate}
        ...
        \item Additional outputs are used to run code from Prof. Paul Palmer, modified by Dr. Luke Surl which provides another AMF calculation
    ...
    GEOS-Chem output of HCHO does not differ much between runs with or without the UCX.
