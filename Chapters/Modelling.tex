...
\label{Model:Analysis}
  ...
  \label{Model:Analysis:NOx}
    ...
    Figure \ref{Model:Analysis:NOx:fig_GC_vs_OMNO2d_AUS_Summer_2005} shows the direct comparison between these datasets averaged over January to February, 2005.
    ...
    Figure X shows an analysis of GEOS-Chem NO emissions and their corellations with the bias between GEOS-Chem NO$_2$ mid-day columns and the OMNO2d product, averaged over January to February 2005.
    The scatter plots have one datapoint for each land square over Australia.
    Figures X-Y show the same analysis for different portions of the year, for both soil and anthropogenic NO emissions.
    TODO: add the plots
