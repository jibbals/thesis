...
\label{BioIsop:intro}  
  ...
  In this thesis I apply the technique focusing solely on Australia for the first time.
  % Too specific
  ...
  \subsection{Aims}
    ...
    First I outline why current isoprene emissions estimates are inadequate and how they can be improved.
  ...
  \subsection{Existing emissions estimates}
    ...
    In this thesis I develop and analyse a top-down emission estimate, which is then compared against MEGAN. I also look at how changed emissions affect modelled ozone levels over Australia.
