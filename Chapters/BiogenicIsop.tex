...
%      }{\label{BioIsop:results:new_emiss:trends:fig_no2_anomalies}}
  ...
  \subsection{Comparison with in situ measurements}
    ...
    \mypic{Figures/OMI_link/GC_vs_Campaigns_20050131-20050601.png}{%
      Comparison between GEOS-Chem HCHO concentrations in the grid square containing Sydney for the duration of the SPS 1 and 2 campaigns}{\label{Model:results:measurements:fig_GC_comparison}}
