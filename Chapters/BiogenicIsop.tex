...
\section{Results}
  ...
  \subsection{A posteriori emissions}
    ...
    \mypic{Figures/OMI_link/Emiss/MEGAN_monthly_daycycle.png}{ %
      ...
      For the Australian average (black), standard deviations for the monthly average are shaded for the a priori, and shown with error bars at 13:30~LT for the a posteriori.
      The coloured lines show the a priori averaged over different regions (see Figure \ref{BioIsop:results:fig_subregions}), while the black lines show the full Australian averaged emissions.
