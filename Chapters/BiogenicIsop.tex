...
\section{Data}
  ...
  \subsection{OMI NO2}
    ...
    See section \ref{BioIsop:Methods:NOx} for how this product was used to check GEOS-Chem calculations.
...
\section{Methods}
  ...
  \subsection{Calculation of Emissions}
    \label{BioIsop:EmissionCalculation}
    ...
    Figure \ref{BioIsop:fig:E_isop_vs_hcho_model_sample} shows the modelled isoprene emissions and column HCHO concentrations along with the RMA regression line, sampled from grid boxes over Australia for January 2005.
    ...
    \begin{figure}[!htbp]
      ...
      \label{BioIsop:fig:E_isop_vs_hcho_model_sample}
    \end{figure}
    ...
    Figure \ref{BioIsop:fig:E_isop_200501} shows the emissions calculated this way along with the Emissions output by GEOS-Chem averaged over January, 2005.
    \begin{figure}[!htbp]
      ...
      \label{BioIsop:fig:E_isop_200501}
    \end{figure}
  ...
  \subsection{Accounting for NOx}
    ...
    Simulated GEOS-Chem tropospheric NO$_2$ columns averaged from 1300-1400~LT are compared against OMNO2d data (Sec. \ref{BioIsop:Data:OMNO2d}). 
    Figure \ref{BioIsop:fig:GC_vs_OMNO2d_2005} shows the direct comparison between these datasets averaged over the month of January, 2005.
    ...
    \begin{figure}[!htbp]
      ...
      \label{BioIsop:fig:GC_vs_OMNO2d_2005}
    \end{figure}
