...
\label{BioIsop:intro}  
  ...
  \subsection{Existing emissions estimates}
    ...
    In this thesis \deleted[id=mh]{I develop and analyse} a top-down emission estimate \replaced[id=mh]{is developed, analysed and}{, which is} then compared against MEGAN. \replaced[id=mh]{H}{I also look at h}ow changed emissions affect modelled ozone levels over Australia \added[id=mh]{is also looked into}.
...
\section{Results}
  ...
  \subsection{A posteriori emissions}
    ...
    \replaced[id=mh]{The a posteriori estimated here to be 21\tgpyr}{Our a posteriori estimate of 21\tgpyr} ~suggests isoprene emissions may be lower than all prior bottom up estimates\replaced{. This}{, and} is close to the lowest top-down estimate of \textcite{Bauwens2016} of 26 \tgpyr.
