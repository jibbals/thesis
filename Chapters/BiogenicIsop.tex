...
\section{Results}
  ...
  \subsection{A posteriori emissions}
    ...
    There is only weak correlation between daily estimates of the a priori and a posteriori ($r < 0.2$), and daily distributions show more variance in the a priori (not shown).
    ...
    In the monthly averages we can see the linear regression coefficient $r$ ranging from 0.48 to 0.78 depending on which region is being compared.
    ...
    Figure \ref{BioIsop:method:scaled:fig_megan_diurnal} shows the multi-year monthly mean daily cycle of isoprene emissions from GEOS-Chem, along with the top-down midday estimate, for an example grid box located 2.5\degr ~west of Sydney.
    This box is typical of our south-eastern region and is not heavily impacted by the anthropogenic filter.
    TODO: Analysis of this and lead into TG/a analysis (following paragraph)
