...
\section{Methods}
  ...
  \subsection{Accounting for smearing}
    ...
    $\hat{S}$ is shown per month in 2005 in figure TODO, along with diamonds and dots in gridsquares above the thresholds of 4000 (as seen in \textcite{Marais2012}) and 6000 (less restrictive) respectively.
