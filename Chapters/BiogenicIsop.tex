...
\section{Results}
  ...
  \label{BioIsop:results:new_emiss}
    ...
    \subsubsection{Implications for HCHO}
      ...
      These $\Oomi$ drive the creation of $\Oogca$, and as we expect the relationship is much improved.
...
%    \label{BioIsop:uncertainty:summary}
  ...
  We can identify the uncertainties in the linear regression used to relate HCHO to isoprene emissions, as well as in the satellite data product used as the basis for the inversion; however, these uncertainties lack verification against measurements.
