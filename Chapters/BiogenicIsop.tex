...
\section{Methods}
  ...
  \subsection{Accounting for smearing}
    ...
    As NO$_X$ levels across Australia are relatively low, the yield is likely lower seen in \textcite{Palmer2003}: and here we use a bounding range of 900 to 5000 for $\hat{S}$.
