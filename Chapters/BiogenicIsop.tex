...
\section{Results}
  ...
  \subsection{Emissions comparisons}
    ...
    In this thesis a top-down estimation its sensitivities is prioritised, along with flow on effect of changed emissions on modelled ozone levels. 
    ...
    There is only weak correlation apparent between daily top down and MEGAN estimations. 
    ...
    In the monthly averages more correlation is apparent, likely from seasonality. 
    %TODO
