...
\section{Results}
  ...
  \subsection{A posteriori emissions}
    ...
    % CLARE NOTE: Also I think that MEGAN predicts emissions practically switch off in the winter months and this is probably wrong - so the real seasonality is probably much less than in the apriori ??
    ...
    \subsubsection{Trends}
      ...
      \mypic{Figures/OMI_link/new_emiss/trend_isop.png}{%
        ...
        TODO: Subtitles changed to a priori and a posteriori (instead of scaled)
  ...
  \subsection{Satellite Uncertainty}
    ...
    \begin{description}
      ...
      \item [Uncertainty in AMF calculations] \hfill \\
        ...
        \textcite{Palmer2006} calculated the error in AMF through combining estimates of error in the UV albedo database ($\sim 8$\%), model error based on in situ measurements, cloud error  ($20-30$\% \parencite{Martin2003}), and aerosol errors ($<20$\%), totalling AMF error of around $\sim 30$\% (calculated in quadrature).
    ...
    \mypic{Figures/OMI_link/mya_Orerr.png}{%
      ...
      TODO: update scales, use 0-3 for aus, 0-4 for se, 0-2 for sw, 0-1 for others ORRR just 0-3.5 for all?
