...
\section{Methods}
  ...
  \subsection{Accounting for smearing}
    ...
    Using the mean HCHO lifetime of $\sim 2.5$ hours applied against $\hat{S}$ from 1000 to 4000 corresponds to yields in the range of $1/9$ to $4/9$~molecules HCHO per C.
