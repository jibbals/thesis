...
\section{Methods}
  ...
  \subsection{Calculating modelled slope}
    ...
    The multiple year monthly averaged slope is used instead when the regression coefficient ($r$) is less than 0.4, or number of datapoints used in the regression ($n$) is less than 10.
    ...
    \mypic{Figures/OMI_link/slope_series_-34.000,150.000_20050101-20121231.png}{%
