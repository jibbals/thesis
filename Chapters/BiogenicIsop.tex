...
\section{Methods}
  ...
  \subsection{Calculating modelled slope}
    ...
    \mypic{Figures/OMI_link/GC/slope_series_20050101-20050531.png}{%
      Row 1: monthly slope along with 95\% confidence interval both with (left) and without (right) applying the smear filter for the model grid square containing Sydney over 2005-2012.
      Row 2: regression coefficient and data-point counts for row 1.
