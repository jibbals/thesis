...
\label{BioIsop:intro}  
  ...
  \textcite{Kefauver2014} reviews remote sensing of (currently rising) BVOC emissions, examining the last 20 years of data and analysis of the satellite products.
...
\label{BioIsop:Uncertainty}
  ...
  \subsection{Model Uncertainty}
    ...
    Uncertainty in modelled yield is based on background HCHO, as well as isoprene emission and HCHO production and background.
    
    Uncertainty in the HCHO background can be determined by looking at total column standard deviation over the remote pacific ocean. This region should be relatively invariant throughout any month so each month the standard deviation of the midday total column HCHO amounts from 15\degr S to 15\degr N, and 180\degr W to 120\degr W.
    TODO: Calculate this and plot over time. 
  ...
  \subsection{Satellite Uncertainty}
    ...
    Since OMI HCHO is scaled up by up to 40\% in several papers, we consider HCHO scaled by 1 and 1.4 to be boundaries satellite HCHO amounts.
