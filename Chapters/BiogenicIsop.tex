...
\section{Results}
  ...
  \subsection{Updated emissions}
    ...
    Northern Australia appears to be overestimated throughout the year, however occasional low points occur in summer in which the a priori is near or lower than the a postiori.
    One potential reason is the onset of the wet season (November-April) which both disrupts the ecosystems and limits satellite measurement (due to cloud coverage).
    ...
    Figure \ref{BioIsop:results:emissions:fig_megan_vs_Enew_regional_mya} shows the multi-year monthly mean and inter-quartile range (IQR) of daily midday isoprene emissions estimates, averaged regionally (see Figure \ref{BioIsop:results:fig_subregions}). 
