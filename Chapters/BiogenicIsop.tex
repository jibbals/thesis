    ...
    \label{BioIsop:results:new_emiss:trends}
      ...
      \begin{table}\begin{threeparttable}
          ...
          \begin{tablenotes} 
            ...
            \item Units are ppbv Carbon for isoprene, ppbv for others.
          \end{tablenotes}
...
%    \label{BioIsop:uncertainty:summary}
  ...
  \subsection{Top down emissions}
    ...
    Figure \ref{BioIsop:uncertainty:fig_Ererrmap} shows the spatial distribution of relative uncertainty in summer and winter.
    The higher latitudes in winter are greatly affected by the higher uncertainty in satellite columns.
