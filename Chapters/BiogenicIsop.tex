...
\section{Methods}
  ...
  \subsection{Modelled background HCHO}
    ...
    % UP TO HERE JENNY
    % JENNY TODO: How? These have been removed. Wouldn't it make more sense if the difference is due to non-isoprene NMVOC precursors (like monoterpenes)? These would cause some HCHO formation over the continent which would raise the background in the non-isoprene case. The pattern in the figure looks consistent with that to me.
    %I haven't looked yet, but the uncertainty in your method due to neglecting non-isoprene biogenic NMVOC sources of HCHO is something you definitely need to mention, and this may be one place where you should first bring it up (with further discussion in uncertainties section).
    The difference between these definitions is approximately $15\%$, and may be due to non-isoprene HCHO precursors such as pyrogenic and anthropogenic emissions.
  ...
  \label{BioIsop:method:smearing}
    ...
    \subsubsection{Modelled HCHO lifetimes}
  ...
  \subsection{A posteriori emissions}
    ...
    \begin{table}\begin{threeparttable}
      ...
      \begin{tablenotes} 
        ...
        \item e: Range shown here based on three models, two of which implement MEGAN.
