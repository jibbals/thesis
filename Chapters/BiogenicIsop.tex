...
\section{Data}
  ...
  \subsection{Drought Index}
    ...
    It is downloaded and stored directly from TODO and holds monthly averaged values at 0.5$^{\circ}$ horizontal resolution.
...
\section{Modelling}
  ...
  \subsection{GEOS-Chem simulation}
    \label{BioIsop:GEOSChemSimulation}
...
\section{Methods}
  ...
  \subsection{CAABA/MECCA Box model: isoprene source classifications}
    \label{BioIsop:Methods:CabbaMecca}
