...
%      }{\label{BioIsop:results:new_emiss:trends:fig_no2_anomalies}}
  ...
  \subsection{Comparison with in situ measurements}
    ...
    The difference between modelled and FTIR vertical column HCHO over Wollongong shows a bias of X, with absolute differences having a standard deviation of Y (TODO).
    This is only qualitative as Wollongong measurements are not representative of the entire grid box which GEOS-Chem averages, and more measurements would be required to estimate model bias over Wollongong.
...
%    \label{BioIsop:uncertainty:summary}
  ...
  \begin{table}\begin{threeparttable}
      ...
      \begin{tabular}{ l | c  c  c | c c c} 
        \toprule
        & & Summer & & & Winter & \\
        Region & $\frac{\Delta \apost}{\apost}$ & $\frac{\Delta \Oomi}{\Oomi}$ & $\frac{\Delta S}{S}$ 
          & $\frac{\Delta \apost}{\apost}$ & $\frac{\Delta \Oomi}{\Oomi}$ & $\frac{\Delta S}{S}$ \\
