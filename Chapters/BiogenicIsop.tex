...
\section{Methods}
  ...
  \subsection{Accounting for smearing}
    ...
    \begin{eqnarray*}
      ...
      Run_2 :&  \prime{\Omega_{HCHO}} = \prime{S} \prime{E_{isop}} + \Omega_0 \\
      Run_1-Run_2 :& \Delta \Omega_{HCHO} = \hat{S} \Delta E_{isop} \\
      & \hat{S} = \frac{\Delta{Omega_{HCHO}}}{\Delta E_{isop}}
    \end{eqnarray*}
    
    The modelled slope multiplied by the column HCHO loss rate ($k_{HCHO}$) should approximate the HCHO yield \parencite{Palmer2003, Barkley2013}.
