...
\section{Results}
  ...
  \label{BioIsop:results:new_emiss}
    ...
    \subsubsection{Implications for HCHO}
      ...
      As a preliminary check on the GEOS-Chem output, I compare simulated $\Ogc$ and $\Ogca$ to $\Oomi$ over January in 2005 in Figure \ref{BioIsop:results:emissions:fig_prelim_new_emiss_HCHO}.
      ...
      Seasonal means and the standard deviations for each region are summarised in Figure TODO.
