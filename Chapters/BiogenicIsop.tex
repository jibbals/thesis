...
\section{Methods}
  ...
  \subsection{Calculation of modelled slope}
    ...
    \mypic{Figures/OMI_link/GC/slope_series_Syd_20050101-20121231.png}{%
      Row 1: monthly slope along with 95\% confidence interval both before (blue) and after (magenta) applying the smear filter for the model grid square containing Sydney over 2005-2012. 
