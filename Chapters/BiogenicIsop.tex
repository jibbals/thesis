...
\label{BioIsop:intro}  
  ...
  \subsection{Top-down isoprene emissions estimates}
    ...
    There are two top-down isoprene emission estimation techniques, Bayesian and linear, which are discussed here.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% MOVE STUFF TO NEW RESULTS %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  
  
\section{OLD results - to be moved}
