...
\section{Methods}
  ...
  \subsection{Accounting for smearing}
    ...
    This is a probelm in Australia where low NO$_X$ environments abound, as detected formaldehyde may have not be directly above its emission source (as assumed in this top-down estimation technique).
    ...
    Once the smearing sensitive grid squares are filtered out, application of equation \ref{BioIsop:Method:slope:eqn_isop_to_hcho} can be used to estimate isoprene emissions across the nation.
