...
%    
  ...
  \subsection{Satellite Uncertainty}
    ...
    \subsection{Sensitivity to AMF recalculation}
      ...
      This figure only depicts grid squares with non-zero emissions, since we are interested in regions where emissions are relatively more substantial within Australia.
