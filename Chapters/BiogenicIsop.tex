...
\section{Results}
  ...
  \subsection{Emissions comparisons}
    ...
    This figure is repeated using monthly medians in (of the daily midday estimates) in \ref{BioIsop:Results:Emissions:fig_time_series_vs_megan_monthly}.
    
    
    \mypic{E_zones_PP_lr.png}{}{\label{BioIsop:Results:Emissions:fig_time_series_vs_megan}}
    \mypic{E_zones_GC_monthly_lr}{ As figure \ref{BioIsop:Results:Emissions:fig_time_series_vs_megan} using monthly medians of the daily midday emissions estimates.}{\label{BioIsop:Results:Emissions:fig_time_series_vs_megan_monthly}}
