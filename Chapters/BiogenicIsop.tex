...
\section{Methods}
  ...
  \subsection{Accounting for smearing}
    ...
    \subsubsection{Calculation of smearing}
      ...
      Table \ref{BioIsop:method:smearing:tab_smearing_ranges} lists the smearing filter and typical slopes determined in literature.
      ...
      The method used here to create a smearing filter is similar to that of \textcite{Marais2012}.
    ...
    \subsubsection{Sensitivity to smearing}
      ...
      Smearing is also sensitive to season and latitude, as higher lower insolation results in slower photolysis.
  ...
  \label{BioIsop:method:scaled}
    ...
    The scaling factor $\alpha$ is the ratio between the multi-year averaged monthly emissions from GEOS-Chem $\apri$ and the a posteriori $\apost$: 
