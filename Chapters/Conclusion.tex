...
\label{Conclusions:ozone}
  ...
  Ozone transported from the stratosphere affects surface ozone levels, although this is hard to detect with the methods used in this thesis.
  We only compare the effect of two disparate influences on the tropospheric ozone column.
  ...
  The impacts are separated by altitude with most STT occurring in the free troposphere, while isoprene emission impacts are largely seen at the surface.
...
\section{Outputs}
  ...
  % JENNY NOTE:Also include Kaitlyn's in prep paper on which you are a co-author, and your "in prep" paper on isoprene. 
...
%JENNY NOTE:I think you could include more here. What about ozone? What about doing full adjoint inversion of HCHO in Australia? Different model resolutions like you were originally planning? etc.? 
  ...
  %, along with missing soil moisture parameterisation are the most likely culprits TODO: cite.
  ...
  Calibrating and applying this update to Australia would be a worthwhile future project.
