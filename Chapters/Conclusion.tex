...
\label{Conclusions:ozone}
  ...
  The sub-regions were detailed in Section \ref{BioIsop:results} and shown \replaced[id=tb]{in Figure \ref{BioIsop:results:fig_subregions}}{again here in Figure 5.2}. 
