...
\label{Conclusions:aims}
  ...
  Chapter \fullref{LR} examines processes leading to ozone creation in the troposphere, primarily isoprene emissions and subsequent chemistry.
  ...
  \textbf{I aime to improve understanding of ozone transported to the troposphere from the stratosphere in Australia and the southern ocean.}
...
\label{Conclusions:isoprene}
  ...
  This estimate is and compared against the bottom-up estimate from GEOS-Chem (running MEGAN).
  ...
  \mypic{Figures/OMI_link/Emiss/E_zones_multiyear_PP_lr.png}{ %
    ...
    Colours denote the region over which the monthly average was taken, as shown in Figure \ref{Conclusions:fig_subregions}.
  }{\label{Conclusions:isoprene:fig_megan_vs_Enew_regional_mya}}
...
\label{Conclusions:ozone}
  ...
  This suggests that impacts from reduced isoprene emission do not propagate vertically.
  ...
  Although isoprene emissions are halved on average over Australia, the reduction has only a small effect on ozone.
