...
\label{Conclusions:ozone}
  ...
  Overall surface ozone drops $\sim 5\%$, with reduction in the tropospheric column totalling less than 1\% meaning that reduction is mostly at the surface.% (figure not shown).
