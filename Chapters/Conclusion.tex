...
\label{Conclusions:aims}
  ...
  This was performed using \replaced[id=mh]{newly developed}{my own} partial AMF recalculation code, along with full recalculation code set up in collaboration with Prof. Palmer and Dr. Surl.
  ...
  In Chapter \ref{BioIsop}\deleted[id=mh]{ I determined} the linear relationship between total column HCHO and biogenic isoprene emissions over Australia \added[id=mh]{is determined} using the global model GEOS-Chem.
...
\label{Conclusions:ozone}
  ...
  \replaced[id=tb]{This was summarised in Figure \ref{BioIsop:results:emissions:fig_ozone_surf_summer} showing summer surface ozone differences before and after scaling isoprene emissions.}{Figure 5.1 shows Australian summer surface level ozone with and without scaling isoprene emissions to match the multi-year top-down estimation.}
  ...
  \replaced{M}{This shows that m}odelled impacts from reduced isoprene emission are seen nearly completely in the surface level, and outweighed by other processes at higher altitudes.
  
  \deleted[id=tb]{Figure 5.1 deleted from this section.}
  ...
  \deleted[id=tb]{The sub-regions were detailed in Section \ref{BioIsop:results} and shown again here in Figure 5.2}.
  ...
  \deleted[id=tb]{Table 5.1 deleted from this section.}
  ...
  \deleted[id=tb]{Figure 5.2 deleted from this section.}
...
\section{Outputs}
  ...
  Analysis of STT along with an estimate of ozone flux from the stratosphere over parts of Australia and the southern ocean was published \replaced{as}{in ACP}: \fullcite{Greenslade2017}.
  
  A top-down estimate of isoprene emissions over Australia created using OMI HCHO and GEOS-Chem modelled chemistry in Chapter \ref{BioIsop} is currently in preparation: Greenslade J. W., Fisher J. A.\replaced{ et al.}{,} Top-down emissions of isoprene over Australia, in prep.
...
\section{Future work}
  ...
  Overall this thesis has contributed to the understanding of two important natural sources of ozone over Australia by improving \replaced[id=mh]{the}{our} understanding of isoprene emissions and by improving the characterisation of stratospheric intrusions.
