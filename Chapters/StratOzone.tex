...
\section{Foreword}
  ...
  \added[id=mh]{Contributions (Section \ref{Ozone:contributions}) are additionally copied here along with an idea of what proportion of the work was performed by the author.}
  
  \added[id=mh]{JWG wrote the algorithms, ran the GEOS-Chem simulations, performed the analysis and led the writing of the paper under the supervision and guidance of SPA, RS, and JAF. 
