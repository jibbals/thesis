...
\section{Foreword}
  This chapter is unchanged (excepting titles, labels, and numbering) from a paper on which I was the first author, published in the journal of Atmospheric Chemistry and Physics: \fullcite{Greenslade2017}.
  ...
  \added[id=mh]{Contributions (Section \ref{Ozone:contributions}) are additionally duplicated here along with an estimate of what proportion of the work that was performed by the author.}
  
  \added[id=mh]{Jesse Greenslade wrote the algorithms, ran the GEOS-Chem simulations, performed the analysis and led the writing of the paper under the supervision and guidance of Simon Alexander, Robyn Schofield, and Jenny Fisher. 
  Andrew Klekociuk contributed the Davis ozonesonde data and performed the analysis of the alternate STT proxy. 
  All authors contributed to editing and revising the manuscript.
  While more than 95\% of the work was performed by the Author, none of it would be possible without the assistance, advice, and expertise of each of the coauthors and those mentioned in the acknowledgements (Section \ref{Ozone:contributions}).}
