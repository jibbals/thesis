...
\section{Isoprene and other VOCs}
  ...
  %  \label{LR:sec:VOCproducts}
    ...
    Reactions with ozone (from alkenes or VOCs containing a double bonded carbon) lead to organic peroxy radicals (RO$\dot{O}$). 
    ...
    Although the PAN formation branch is quite minor, it can be very important as it can transport NO$_X$ to otherwise clean regions, and can build up in the winter \citep{Horowitz1998,Lelieveld2009}.
