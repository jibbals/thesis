...
\section{Hydroxyl (OH) and other radicals (maybe relocate this bit?)} 
    ...
    TODO: Equation, how do I get chem equations in here?
    %\ce{R\sbond CH\dbond CH\sbond R$^{\prime}$ + OH -> R\sbond CH(OH)\sbond CH\sbond R$^{\prime}$ }
    where R and R$^{\prime}$ represents hydrocarbons .
