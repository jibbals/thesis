...
\label{ch_LitRev:sec:isoprene}
  ...
  \subsection{Sources and Sinks}
    ...
    In \citet{Paulot2009b}, the HO$_X$ levels are largely unnaffected by isoprene concentrations.
    They show that ISOPOOH is formed in yields $\gt 70\%$, and MACR and MVK is formed with yields $\lt 30\%$.
    The secondary process produces some HO$_X$, although not enough to close the gap.
    ...
    They then use GEOS-Chem to estimate that one third of isoprene peroxy radicals react with HO$_2$, and two thirds react with NO. 
