...
\label{ch_LitRev:sec:what_are_vocs}
  \subsection{VOCs}
    ...
    They estimate emissions of Biogenic VOCs (BVOCs) to be 760~Tg(C)yr$^{-1}$, 70\% of which is isoprene.
    This is equivalent to X~Mt of isoprene (TODO: ask steve for conversion - confirm Atkinson uses non per C units).
    
    MEGAN emissions estimates are termed bottom-up, as opposed to top-down estimates which are derived from satellite measurements of the products of various VOCs.
    Using GOME satellite HCHO and a Beyesian inversion technique to derive isoprene emissions, \citet{Shim2008} estimated global isoprene emissions to be  $\sim$566 TgC yr$^{-1}$. 
    ...
    The process of deposition only accounts for a small fraction of the VOC loss (todo: cite with numbers), with the primary reductions occurring through photochemical drivers.
  ...
  \subsection{Hydroxyl (HO) and other radicals}
    ...
    \end{align*}
    A build up of NO$_3$ radicals can be seen at night, when the quick photolysis is not occurring \citep{Atkinson2000}.
...
\label{ch_LitRev:sec:HCHO}
  ...
  \subsection{Measurements}
    ...
    The measurements of light absorption are performed over several elevations in order to add some vertical resolution to the measurement of trace gas concentrations.
    An example of this is shown in figure \ref{ch_LitRev:fig:MAXDOASExample}, which was taken from \citet{Lee2015}.
    Recently MAX-DOAS has been used to examine HCHO profiles in the clean free troposphere \citep{Schreier2016} as well as in polluted city air \citep{Lee2015}.
