...
\section{Tropospheric ozone and air quality}
  ...
  \subsection{Air Quality}
    ...
    One important factor, affecting particulate matter and ozone concentration (both detrimental to human health), is a group called Volatile Organic Compounds (VOCs).
    ...
    Since many Australian cities are on the edge of regions with rich VOC emissions, it is very important to try to get a clear picture of both how much VOCs are being emitted, and where these emissions are coming from.
    ...
    \subsubsection{How do we determine this?}
      ...
      In New South Wales (NSW) there are several metrics used to determine air quality: particulate matter (PM), O$_3$, CO, NO$_2$, SO$_2$, and visibility.
      PM is separated into size bins: with radius $< 2.5 $~$\mu$m and $<10$~$\mu$m being PM$_{2.5}$, and PM$_{10}$ respectively.  
      An air quality index equal to the worst of these metrics is used for NSW as seen in \url{http://www.environment.nsw.gov.au/aqms/aqitable.htm}, and similar methods are used in other states (TODO) to get an idea of air quality.
      Measurement stations include the bureau of meteorology (BOM) sites shown in figure TODO, as well as todo other measurement sites, and are generally located in population centres. 
...
\section{Models}
  ...
  \subsection{Uncertainties}
    ...
    % SMEARING uncertainty, other transport uncertainties?
    \subsubsection{Transport}
      ...
      Smearing has been measured in order to account for this uncertainty in various works \citep{Martin2003,Palmer2003,Millet2006,Marais2012,Barkley2013,Zhu2014,Wolfe2016}, mostly implementing the method designed in \cite{Palmer2003}.
      
      TODO: more examples of transport uncertainties
