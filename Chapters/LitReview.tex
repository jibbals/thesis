...
\section{Tropospheric ozone and air quality}
  ...
  \subsection{Ozone formed in the troposphere}
    ...
    The main loss channel is through equation \ref{LR:Radicals:O3toOH}, where photolysis and pressure create OH from the O$_3$.
    ...
    Equation \ref{LR:Radicals:O3toNO2} shows how NO and O$_3$ lead to NO$_2$ and the very short lived NO$_3$ radical.
...
\section{Isoprene and other VOCs}
  ...
  \subsection{What are VOCs}
    ...
    Isoprene affects NO$_X$ and HO$_Y$ cycling, see for example formulae \ref{LR:Radicals:O3toOH,LR:Radicals:O3toNO2}.
  ...
  \subsection{Emissions estimates}
    \label{LR:O3andAQ:EmissionsEstimates}
    ...
    Non methane BVOC emissions are estimated to be $\sim1150$ TgCyr$^{-1}$, of which isoprene (44\%) and monoterpenes (11\%) are the main single contributors (\cite{Guenther2000, Kefauver2014}). 
  ...
  \subsection{Satellite inversion}
    \label{LR:VOCs:SatelliteInversion}
...
\section{Formaldehyde (HCHO)}
  ...
  \subsection{How HCHO is measured}
    ...
    An example of this is shown in figure \ref{LR:fig:MAXDOASExample}, which was taken from \cite{Lee2015}.
  ...
  \subsection{Sources and sinks}
    ...
    %HCHO SINKS
    HCHO has two major sinks, one being reactions with OH (oxidation), the other being photolysis (\cite{Crutzen1999, Wagner2002, Levy1972, Kefauver2014}).
  ...
  \subsection{Satellite HCHO detection}
    ...
    Satellites record near nadir (nearly vertical) reflected spectra between around 250-700~nm split into spectral components at around $0.3$~nm in order to calculate trace gases including O$_3$, NO$_2$, and HCHO (eg: \cite{Leue2001}).
    ...
    \subsubsection{AMF}
      ...
      These AMFs are measures of how radiance at the top of the atmosphere (TOA) changes with trace gas optical depths at specific altitudes (\cite{Lorente2017}).
      ...
      One way to remove these apriori influences is through the satellite's AK (or by using AMFs), which takes into account the vertical profile of the modelled trace gas and instrument sensitivity to the trace gas (\cite{Eskes2003, Palmer2001}).
      ...
      \cite{Lorente2017} show that AMF calculations can still be the largest source of unertainty in satellite measurements.
...
\section{Models}
  ...
  \subsection{How can models help}
    ...
    \begin{figure}
      ...
      \caption{ Standard box model parameters, image taken from \cite{Jacob_1999_book}. }
  ...
  \subsection{Uncertainties}
    ...
    \subsubsection{Soil Moisture}
      ...
      \cite{Sindelarova2014} show reductions in modelled Australian isoprene emissions of 50\% by accounting for soil moisture. 
