...
\section{Models}
  ...
  \subsection{How can models help}
    ...
    They can be used to increase measurement accuracy (for instance in satellite measurements) and determine where we lack information, as well as check the performance of new instruments.
