...
\label{ch1:sec:isoprene}
  ...
  \subsection{Isoprene From HCHO}
    ...
    \end{equation}$
    where b is the background HCHO and $\epsilon is errors in measurement.
    K is the Jacobian matrix determined from CHIMERE, and represents the sensitivity of y to the state variable x.
    TODO: some more on the bayesian technique from CURCI here..
