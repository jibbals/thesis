...
\label{ch_LitRev:sec:emissions}
  ...
  \subsection{Australia}
    ...
    VOC emission is based on many factors, including plant type and soil moisture (todo: find soil moisture citation or email K. emerson for one), both of which are not well characterised in Australia \citep{Bauwens2016}.
...
\label{ch_LitRev:sec:isoprene}
  ...
  \subsection{Isoprene to HCHO}
    ...
    The beyesian inversion is similar to that of \citet{Curci2010}, where a regional CTM (CHIMERE) simulates HCHO, which is compared against OMI observed HCHO and shown to be regionally biased.
