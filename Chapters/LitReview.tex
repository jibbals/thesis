...
\section{Tropospheric ozone and air quality}
  ...
  \subsection{Air Quality}
    ...
    Biogenic emissions affect surface pollution levels and can alter the radiative processes in the atmosphere with harmful results.
    ...
    Particulate matter (PM) in the atmosphere is also a major problem, causing an estimated 2-3 million deaths annually \citep{Hoek2013, Krewski2009, Silva2013, Lelieveld2015}. 
    
    One important factor, affecting PM and ozone concentration (both detrimental to human health), is a group called Volatile Organic Compounds (VOCs).
    ...
    Atmospheric VOCs can form secondary organic aerosols (SOA) which are detrimental to human health.
    ...
    Not only are these factors poorly characterised, the estimates are highly sensitive to them.
    ...
    \subsubsection{How do we measure air quality?}
      ...
      These various measurements can be used to improve models, which can be used to predict harmful and costly events, as well as prevent scenarios in which pollution events are likely.
      ...
      They then use GEOS-Chem with their updated emissions and show how surface ozone is affected, with a seasonal increase of 5-20~ppb.
      
      Many models lack in-situ measurements with which to verify their chemical mechanisms, which leads to large discrepancies, as seen in \cite{Marvin2017a}.
