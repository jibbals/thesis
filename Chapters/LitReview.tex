...
\section{Tropospheric ozone and air quality}
  ...
  \subsection{Air Quality}
    ...
    \subsubsection{How do we determine this?}
      ...
      Australian air quality is monitored independently within each state, using various metrics measured by varying numbers of monitoring stations.
      ...
      Measurement stations are generally located in population centres, and don't regularly measure precursor emisisons. 
      ...
      These measurements can be used to determine emissions of precursor gases which affect air quality and that we don't measure directly.
