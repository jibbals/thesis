...
\section{Tropospheric ozone and air quality}
  ...
  \subsection{Air Quality}
    ...
    \subsubsection{How do we measure air quality?}
      ...
      % UP TO HERE READING OUT LOUD TODO: CONTINUE
  ...
  \subsection{Ozone trasported from the stratosphere}
    ...
    %% STT
    Historically (in the late 1990's), ozone transported down from the stratosphere was thought to contribute 10-40~ppb to tropospheric ozone levels, matching tropospheric production (shown in equation \ref{LR:eqn:MethaneBackground}) \citep{Atkinson2000,Stohl2003}.
  ...
  \subsection{Ozone formed in the troposphere}
    ...
    Methane and isoprene each comprise around a third of the global total VOC emissions of VOCs (\cite{Guenther2006}).
...
\section{Isoprene and other VOCs}
  ...
  \subsection{What are VOCs}
    ...
    \cite{Guenther1995}, and subsequent updates \citep{Guenther2000,Guenther2006,Guenther2012}, have been used ubiquitously by the atmospheric community as a global estimate of isoprene emissions, at roughly 500-600 Tg yr$^{-1}$, emitted mostly during the day.
  ...
  \subsection{What do they Do?}
    ...
    They've also been shown to impact secondary inorganic aerosol concentrations through a regional model study in Europe (\cite{Aksoyoglu2017}).
...
\section{Formaldehyde (HCHO)}
  ...
  In the continental boundary layer, HCHO enhancement is generally driven by short lived ($<1$~hr) precursors (such as isoprene and other VOCs), with a lifetime of a few hours \citep{Kefauver2014}.
  ...
  \subsection{Sources and sinks}
    ...
    %TODO: sources?
    Other terpenoids can also produce HCHO, although generally to a lesser extent than isoprene, methane and biomass burning.
    ...
    % TODO: find a couple of chamber studies to cite (should already be in my thing)
