...
\section{Tropospheric ozone and air quality}
  ...
  \subsection{Stratospheric ozone}
    ...
    \begin{eqnarray*}
      \text{O}_2 + hv(\lambda < 242 \text{nm}) & \rightarrow & \text{O} + \text{O} \\
    ...
    \end{eqnarray*}
    Where $hv$ represents photons, M is an inert molecule (such as N$_2$).
    ...
    Since [O] $<<$ [O$_3$] the defining a chemical family O$_X$ (  O$_X \equiv $ O $+$ O$_3$ ) can be used to simplify chemistry simulations and approximate O$_3$ concentrations \citep{BrasseurJacob2017}.
