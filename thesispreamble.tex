...
\usepackage[sorting=none,backend=bibtex,style=authoryear,natbib=true]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
...
\newcommand{\degr}{~$^{\circ}$}
\newcommand{\roo}{RO$\dot{O}$ } %% hydroxyperoxyl radical (isopoo, roo, ro2,...)
