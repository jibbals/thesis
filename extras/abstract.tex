...
\added[id=mh]{Australia lacks the extensive in-situ measurement sites (or network) required to fully attribute ozone concentrations to these different sources within either regional or urban areas.}
\replaced[id=mh]{The primary source is chemical production, which }{Chemical production }can occur following biogenic emissions of volatile organic compounds (VOCs) when they mix with polluted urban air.
...
\added[id=mh]{The second most important source of tropospheric ozone is the stratosphere, which occasionally mixes into the troposphere bringing ozone-rich air masses down towards the Earth's surface.}
Transport of ozone from the stratosphere is \deleted[id=mh]{also }uncertain, and difficult to measure.
%% Gaps
...
In this thesis, \replaced[id=mh]{a}{A} linear model was created using modelled isoprene emissions and associated formaldehyde enhancements over Australia.
...
\added[id=mh]{Summer (peak season) reductions averaged at $\sim{50\%}$ and varied spatially.}
This leads to an overall lowering of surface background ozone concentrations of approximately 5\%.

%% Ozone chapter
%
\replaced[id=mh]{In order to examine potential stratospheric sources of tropospheric ozone,}{The second most important source of tropospheric ozone is the stratosphere, which occasionally mixes into the troposphere bringing ozone-rich air masses down towards the Earth's surface.
...
\added[id=mh]{Background ozone concentrations are the basis for ozone pollution and air quality metrics. How these concentrations are affected by over-represented isoprene emissions and by transport from the stratosphere is now better understood for Australia and the nearby Southern Ocean.}
